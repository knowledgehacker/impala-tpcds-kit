...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('spring','sandy','cornsilk'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-01-04','2002-08-24','2002-11-13')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 146 and 146+10 
             or ss_coupon_amt between 7475 and 7475+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 173 and 173+10
          or ss_coupon_amt between 13760 and 13760+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 20 and 20+10
          or ss_coupon_amt between 16663 and 16663+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 119 and 119+10
          or ss_coupon_amt between 6468 and 6468+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 183 and 183+10
          or ss_coupon_amt between 17148 and 17148+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 115 and 115+10
          or ss_coupon_amt between 7778 and 7778+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '54796','99982','69945','99353','90176','41118',
                          '98713','24885','17734','63617','36611',
                          '34693','68732','36307','21117','57538',
                          '28806','38122','14507','98098','13993',
                          '47879','58518','42807','29231','37173',
                          '42887','62369','99987','65458','37991',
                          '33430','40569','95194','27042','84645',
                          '76188','57207','63114','39238','77867',
                          '59123','80491','89058','50971','22440',
                          '41090','61144','64684','75019','68956',
                          '84038','37996','72257','78549','10378',
                          '24937','72273','79721','74160','34309',
                          '65923','72244','79865','92205','88795',
                          '64097','98381','40004','45005','89530',
                          '23810','67789','58405','83739','94072',
                          '86638','12648','41782','37652','94369',
                          '25031','47711','21181','17915','30285',
                          '83139','32486','79229','34850','17408',
                          '99888','32950','16847','71576','38185',
                          '78426','53251','32877','34551','32403',
                          '14011','65027','66494','79667','94321',
                          '26389','35615','15330','28510','94176',
                          '90621','96451','46264','60393','95717',
                          '33353','42370','64912','85026','75683',
                          '41349','56951','29615','45875','24505',
                          '62931','52904','26427','38448','37191',
                          '87815','72969','33097','49683','19079',
                          '89056','28540','21271','84928','37367',
                          '91723','85858','45757','63243','26575',
                          '26240','90300','97296','63475','25276',
                          '32350','52858','65623','29842','32837',
                          '48782','51147','37327','28867','26690',
                          '82464','50787','87980','63649','13005',
                          '68165','48151','53988','16256','96752',
                          '29854','33814','73242','47994','57373',
                          '81147','52956','13592','39788','89781',
                          '41151','19655','74715','75870','78908',
                          '94025','93778','32736','22478','28596',
                          '79009','21441','73976','11836','77579',
                          '38513','46303','46289','91375','30815',
                          '95122','11945','67802','64677','85563',
                          '20054','15006','36116','51895','19907',
                          '57357','84204','18236','90285','85756',
                          '63237','21263','20475','65102','56624',
                          '11451','75123','78917','15057','45816',
                          '67441','75541','98193','67211','52008',
                          '98290','10640','39426','29974','90379',
                          '82001','25429','62300','81705','56571',
                          '94127','81364','23728','84046','97410',
                          '57943','36657','42610','68947','97678',
                          '64763','60065','35906','66573','32368',
                          '20614','72573','36999','14665','55043',
                          '75708','57559','42149','62910','32754',
                          '67653','38569','15099','48446','62272',
                          '86670','90589','18524','19074','82874',
                          '95950','74802','55762','23557','82337',
                          '27768','82608','26829','81900','46427',
                          '82772','47533','31704','87811','40967',
                          '20286','27079','96899','89037','74614',
                          '59443','27159','35678','60544','13254',
                          '29491','26464','23450','46346','92828',
                          '76771','90012','99513','64109','88579',
                          '40255','51088','80118','27277','70343',
                          '58333','99807','73007','33281','43119',
                          '41776','99874','80357','34448','78709',
                          '79316','34557','78782','90690','93267',
                          '12631','17506','72631','50984','21351',
                          '26678','27073','99347','75550','47455',
                          '33067','75975','73474','46280','41361',
                          '64569','38883','54759','70669','13064',
                          '14939','47192','13102','39590','95369',
                          '29627','43487','20980','21692','71504',
                          '32186','31392','23781','20059','49587',
                          '31070','88094','77129','35067','90191',
                          '49921','34178','57863','21778','66925',
                          '64709','21589','54907','53558','60125',
                          '71553','64637','81046','14467','31254',
                          '46697','46847','58013','49230','83447',
                          '85482','81030','84189','56412','43634',
                          '33435','27556','87524','95797'))
     intersect
     (select ca_zip
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-12' as date) 
                  and (cast('1999-08-12' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Hamlin County','Tuolumne County','Hand County','McLean County','Prince George County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('2002-04-15' as date) and (cast('2002-04-15' as date) +  60 days)
 and i_manufact_id in (159,153,580,38)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Lincoln'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  4911
   and ib_upper_bound   <=  4911 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-02-24' as date) and (cast('1999-02-24' as date) +  60 days)
 and i_manufact_id in (741,713,936,957)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navy','chartreuse','puff','mint','goldenrod','aquamarine') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 15018
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 31871
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 37951
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 8868
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 20028
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,11,10,12,9) and
       d_year = 2000 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'WI', 'SD')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'KS', 'MI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'LA', 'MT')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 808 and 808+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'yellow' or i_color = 'dark') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'lawn' or i_color = 'chartreuse') and
...
and d_date between '2002-02-27' and 
        (cast('2002-02-27' as date) + 90 days)
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Books','Women','Home') and
          i_class in ('parenting','fragrances','bedding')
         )
      or (i_category in ('Shoes','Music','Jewelry') and
          i_class in ('kids','pop','diamonds') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 35652 and 35652+28800 
