...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Children','Music','Electronics') and
          i_class in ('newborn','country','automotive')
         )
      or (i_category in ('Home','Jewelry','Sports') and
          i_class in ('paint','gold','tennis') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-08' as date) 
                  and (cast('2000-08-08' as date) +  14 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,4,10,5,7,1) and
       d_year = 2001 and
       ca_state in ('IA','NC','ND'
                   ,'NH','IN','OH','MS')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('violet','slate','seashell'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 3
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Arlington'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  18847
   and ib_upper_bound   <=  18847 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Dallas County','Pratt County','Lake County','Floyd County','Clinton County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '45005','19365','85921','91809','36830','41886',
                          '74243','83827','94396','85409','49669',
                          '78420','18288','77118','48647','34062',
                          '74340','58994','75049','92301','93888',
                          '16273','94439','39806','13829','37563',
                          '26249','35603','61392','96779','37450',
                          '29654','76690','96230','47433','22573',
                          '53828','49725','82124','59725','17021',
                          '61752','87214','69102','86969','95114',
                          '96476','13810','19316','28686','81485',
                          '51521','95748','96141','13714','67033',
                          '90636','93086','78955','90168','87472',
                          '84293','13568','58372','35952','93670',
                          '95002','94252','85618','80115','89775',
                          '61379','59677','50261','95144','29309',
                          '89452','93838','38032','41786','49052',
                          '24477','84713','49234','96533','29280',
                          '78403','80064','26631','11864','26142',
                          '10485','87736','23874','29730','93354',
                          '97445','36846','54345','58950','49300',
                          '38007','95091','76074','46004','89485',
                          '66501','73031','74523','27131','48026',
                          '52237','91820','20406','86140','47969',
                          '50491','40172','98054','78911','35001',
                          '19963','25513','43196','55958','65260',
                          '50790','82677','70714','66634','30014',
                          '36728','61383','61470','34530','43674',
                          '12483','87421','25749','25952','60143',
                          '43420','47383','28964','69228','35745',
                          '62147','96575','52753','39889','61173',
                          '51012','16388','81630','40647','18277',
                          '16461','24374','54114','80981','78976',
                          '76089','53752','94019','62134','22009',
                          '57081','23597','20563','98762','62837',
                          '45877','96469','34658','61166','84313',
                          '15314','21878','22674','32383','14590',
                          '91010','36123','60151','58662','41739',
                          '62846','24285','83626','17865','82823',
                          '89593','77694','12691','86397','86277',
                          '46149','35244','81514','52866','14072',
                          '70911','48075','92780','88894','52968',
                          '33588','20142','50889','12111','12406',
                          '82749','98628','11118','47409','50184',
                          '90992','61676','80835','11161','91085',
                          '17502','70820','99248','10033','86179',
                          '29369','49168','86591','51970','78265',
                          '13597','66880','28747','14287','62910',
                          '95026','71743','29385','32378','48629',
                          '13422','87785','65149','61986','65264',
                          '46963','46164','53191','33038','53832',
                          '28352','33437','15136','91563','96246',
                          '22845','52118','30867','57968','46671',
                          '67572','38004','40417','56447','76110',
                          '25219','70487','40235','82841','20132',
                          '45920','80582','12002','67265','41614',
                          '61769','40344','83024','60303','69612',
                          '26014','46877','84012','84635','33945',
                          '19927','96302','64999','93179','49520',
                          '67924','99767','75115','40363','33107',
                          '53740','36060','39082','24260','18223',
                          '66383','55436','49858','94184','20076',
                          '49668','23796','36466','31953','51823',
                          '57825','84610','28582','16549','47800',
                          '66087','19454','88798','82556','42375',
                          '26731','17898','29704','14236','30902',
                          '27008','26459','59545','78295','75385',
                          '63343','77329','43379','80447','57488',
                          '33115','90282','38837','67907','92245',
                          '42853','78254','83963','23708','22094',
                          '57812','72127','64883','74423','95056',
                          '93148','23083','30573','48532','66335',
                          '35051','24984','47310','41887','15045',
                          '10076','38111','96962','65753','79959',
                          '63307','90539','90585','98111','45266',
                          '83726','11336','71939','88797','67545',
                          '22930','50256','34235','23209','77015',
                          '97383','43621','20547','10898','82453',
                          '83886','32333','39093','27916','55576',
                          '33315','69416','49697','97014','13876',
                          '77997','83889','63093','37580'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (880,835,841,821)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 1165 and 1165+28800 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2000-04-03' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-04-03' as date) - 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-06-02' as date) and (cast('2002-06-02' as date) +  60 days)
 and i_manufact_id in (555,129,639,220)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 827 and 827+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'burlywood' or i_color = 'midnight') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-04','2001-10-08','2001-11-15')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 9 and 9+10 
             or ss_coupon_amt between 16531 and 16531+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 77 and 77+10
          or ss_coupon_amt between 4585 and 4585+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 169 and 169+10
          or ss_coupon_amt between 9224 and 9224+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 30 and 30+10
          or ss_coupon_amt between 11285 and 11285+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 56 and 56+10
          or ss_coupon_amt between 16732 and 16732+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 22 and 22+10
          or ss_coupon_amt between 6227 and 6227+1000
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Women', 'Men', 'Sports')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1999-02-27' as date) 
				and (cast('1999-02-27' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('coral','khaki','burnished','grey','ivory','olive') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 18110
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 46315
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 10448
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 10853
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 18964
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	ss_item_sk = i_item_sk 
  	and i_category in ('Home', 'Electronics', 'Jewelry')
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('1998-06-30' as date) 
