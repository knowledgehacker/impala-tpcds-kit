...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-16' as date) 
                  and (cast('1998-08-16' as date) +  14 days)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  31773
   and ib_upper_bound   <=  31773 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NH', 'MS', 'WI')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MI', 'TN', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'OH', 'IN')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-05-25' as date) - 30 days)
                    and (cast ('2002-05-25' as date) + 30 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 33569
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 41021
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 2085
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 38426
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 6770
            then (select avg(ss_ext_list_price)
                  from store_sales
...
and d_date between '1998-01-16' and 
        (cast('1998-01-16' as date) + 90 days)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 17 and 17+10 
             or ss_coupon_amt between 1828 and 1828+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 162 and 162+10
          or ss_coupon_amt between 5688 and 5688+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 42 and 42+10
          or ss_coupon_amt between 12570 and 12570+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 182 and 182+10
          or ss_coupon_amt between 81 and 81+1000
...
select  i_item_id
 ...
 and d_date between cast('2001-06-22' as date) and (cast('2001-06-22' as date) +  60 days)
 and i_manufact_id in (753,616,841,297)
...
select  
 ...
 where
  ...
  ca_county in ('Scott County','Chilton County','Coshocton County','Wabash County','Union County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,9,2,11,5,6) and
       d_year = 1999 and
       ca_state in ('TX','GA','NY'
                   ,'CA','MS','MN','ID')
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 47685 and 47685+28800 
...
where 
	...
	and d_date between cast('1998-05-27' as date) 
				and (cast('1998-05-27' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Books','Electronics','Home') and
          i_class in ('mystery','karoke','mattresses')
         )
      or (i_category in ('Music','Children','Women') and
          i_class in ('country','infants','swimwear') 
        ))
 ...
 where i_manufact_id between 862 and 862+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'dim' or i_color = 'lavender') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-12','2001-10-08','2001-11-13')))
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('ghost','blanched','chartreuse','bisque','moccasin','coral') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('dim','papaya','purple'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 4
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-06-10' as date) and (cast('1999-06-10' as date) +  60 days)
 and i_manufact_id in (949,767,677,965)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '68545','84987','12225','86076','47461','25228',
                          '76892','55225','52095','39463','11926',
                          '37047','49576','92561','15166','46566',
                          '58785','23367','24373','37269','75051',
                          '86671','48093','68166','47524','62450',
                          '16024','30827','10396','79044','92594',
                          '43013','97220','67629','23742','40284',
                          '34181','56430','77805','90668','57237',
                          '58877','54032','81617','54964','86995',
                          '91206','15076','41123','19525','63230',
                          '10680','53979','54921','30297','14611',
                          '97914','81714','78924','45696','80876',
                          '35092','14479','96344','82264','76731',
                          '71010','88791','85736','55705','80107',
                          '55885','70841','86040','87067','96822',
                          '23193','46377','42999','84479','53715',
                          '52932','43371','64029','33864','51020',
                          '81930','21286','36282','16184','62312',
                          '69273','73531','95978','52963','20696',
                          '30441','72976','76375','17628','11336',
                          '39559','11847','37259','16333','15896',
                          '73567','67542','30488','58904','84059',
                          '54253','25547','32852','79934','99665',
                          '45924','64393','58938','20950','34031',
                          '73783','63384','73736','18269','17223',
                          '44109','22853','50685','12245','10822',
                          '83338','72923','38380','56348','31240',
                          '40701','45051','95566','75951','93484',
                          '37191','89167','95616','62121','73068',
                          '91660','25949','78159','86176','50910',
                          '33875','20942','64282','79426','69003',
                          '11724','20562','81132','93566','73844',
                          '25215','47759','86643','39062','84844',
                          '61993','61047','19307','34995','37135',
                          '76379','17610','23695','65341','22567',
                          '64557','40489','29873','56665','71034',
                          '21207','91765','84320','14009','24829',
                          '59875','26849','15074','13773','90228',
                          '17214','45188','80925','51122','58551',
                          '95249','72702','65782','97391','57308',
                          '63018','15779','62619','20881','55725',
                          '48073','25707','65875','69261','94549',
                          '86393','56045','74661','31075','53380',
                          '61706','71645','47689','94648','22952',
                          '63668','36364','78729','94913','95462',
                          '20999','18970','45215','69585','91129',
                          '56015','47466','78825','44745','90303',
                          '16211','73608','73131','23117','60645',
                          '14972','58042','83299','29531','66296',
                          '67432','87100','43278','10047','79773',
                          '81262','53789','47776','99941','64845',
                          '14042','66812','90331','11174','60845',
                          '73241','29301','81855','99358','12280',
                          '31309','61286','26809','46898','47869',
                          '35671','20959','98264','72679','43822',
                          '92669','40233','99339','58383','97106',
                          '88814','32697','24520','39577','77676',
                          '59275','51023','69965','25307','75331',
                          '43127','99626','18977','87838','38478',
                          '10649','94850','49214','25018','90584',
                          '54419','59088','22405','99105','92266',
                          '82762','15457','64712','37846','39604',
                          '28187','17193','80188','52925','85350',
                          '63868','33902','79703','67182','19151',
                          '92366','71950','74033','17535','97145',
                          '67926','44792','45805','35503','90706',
                          '68907','61622','92915','75150','32383',
                          '68205','54469','31890','18163','68938',
                          '52058','28128','14193','51714','51597',
                          '78716','19043','94725','91386','63593',
                          '84586','52668','23309','45196','32042',
                          '29823','30688','65359','80629','12859',
                          '45324','76325','35269','35409','93006',
                          '30863','60149','48583','94800','53157',
                          '89637','62103','50170','12492','53530',
                          '96247','66838','45043','84510','66310',
                          '49099','54986','55516','15175','94889',
                          '54247','90425','84574','58433','26012',
                          '60142','13193','54902','83967','46995',
                          '91388','26903','29968','15797'))
     intersect
     (select ca_zip
