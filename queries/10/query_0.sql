...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Midway','Fairview','Riverside','Pleasant Hill') 
...
select  
 ...
 where
  ...
  ca_county in ('Jefferson County','Washington County','Union County','Hawaii County','Archer County') and
...
select  i_item_id
 ...
 and d_date between cast('1999-04-27' as date) and (cast('1999-04-27' as date) +  60 days)
 and i_manufact_id in (680,787,841,687)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 39 and 39+10 
             or ss_coupon_amt between 7994 and 7994+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 20 and 20+10
          or ss_coupon_amt between 9439 and 9439+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 4853 and 4853+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 8129 and 8129+28800 
 	and sm_carrier in ('USPS','GERMA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
and d_date between '1998-02-06' and 
        (cast('1998-02-06' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 97867
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 18558
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 28375
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 227008
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 183465
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Books','Children','Electronics') and
          i_class in ('science','infants','scanners')
         )
      or (i_category in ('Home','Jewelry','Sports') and
          i_class in ('blinds/shades','semi-precious','optics') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 930 and 930+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'yellow' or i_color = 'sky') and 
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '89248','55301','42131','88405','19763','19801',
                          '23667','11766','19742','25781','39072',
                          '47593','71955','79655','92273','34144',
                          '66006','74426','45527','35968','69595',
                          '91029','36100','18731','64385','39882',
                          '43132','12439','76699','98273','20136',
                          '78138','13285','99968','30384','29473',
                          '43499','65601','94361','62777','58624',
                          '32372','11504','20407','89291','14570',
                          '32993','44836','20060','57839','83888',
                          '32669','86941','41648','71928','72147',
                          '12541','74227','61281','23824','75281',
                          '98446','33550','26939','38164','17081',
                          '53213','14038','86964','13476','44022',
                          '63963','13628','33474','39131','87314',
                          '76594','75985','71514','29975','45311',
                          '10580','47480','77012','54814','14602',
                          '31342','11953','95493','30528','51584',
                          '11552','82391','32516','14989','53102',
                          '31987','71679','61573','41613','21232',
                          '63864','29747','51232','73392','30527',
                          '72222','70713','54624','46798','33742',
                          '16333','50435','89137','29884','92077',
                          '23887','60902','50891','20562','65213',
                          '98188','78311','75073','24437','99653',
                          '98386','27888','24269','97658','88421',
                          '67020','55918','91646','30233','55141',
                          '42664','30190','34918','10763','93534',
                          '51020','13735','93478','60589','33188',
                          '60843','96290','22257','54906','30110',
                          '77647','14258','17892','26314','62465',
                          '64679','47183','84505','27050','36498',
                          '74274','71129','40657','43974','75606',
                          '15526','78079','12711','81856','31891',
                          '81846','14056','43938','71708','35904',
                          '43790','26363','72302','50175','55447',
                          '25514','35183','41048','21713','66663',
                          '26362','13219','24655','30486','41421',
                          '60365','43570','22700','50827','99006',
                          '50727','85252','27395','70315','95751',
                          '80519','11208','17260','32231','29732',
                          '32741','28269','36438','14043','18424',
                          '15844','86883','30548','24818','23843',
                          '99872','88313','38491','49826','27704',
                          '83884','63776','90416','25930','39289',
                          '88826','19299','27654','86810','40864',
                          '38145','27640','72106','33558','45596',
                          '14627','68858','29604','85108','34066',
                          '61960','50048','76467','13028','68370',
                          '32366','27917','15981','13350','75610',
                          '90119','31269','53444','44974','12399',
                          '29292','47245','38764','35484','80811',
                          '56310','12131','69726','56995','77753',
                          '72126','35621','47971','35268','61620',
                          '30135','33562','95931','74732','36421',
                          '37973','92978','58957','41799','81344',
                          '40752','24009','52269','86117','61852',
                          '83641','53593','18396','81320','46487',
                          '17972','51933','71386','87091','88434',
                          '52871','12414','49319','50548','57737',
                          '79877','95192','48330','76531','61768',
                          '82079','81036','94029','56184','17776',
                          '81487','42124','22584','36267','16766',
                          '41404','24429','24391','61450','48243',
                          '71127','27376','24397','97854','54440',
                          '65563','45759','14835','54479','87924',
                          '59593','82041','67431','25715','32323',
                          '82098','88012','38447','69669','29497',
                          '65400','75627','28074','78761','56607',
                          '79575','23972','51552','23036','11625',
                          '67034','72079','79196','76249','81364',
                          '21258','23422','23669','61988','74338',
                          '57050','26077','69399','87298','61057',
                          '52725','81783','71564','25091','31488',
                          '25726','35008','71076','36875','44111',
                          '63376','39094','32150','74866','56133',
                          '29136','78228','48464','33064','23311',
                          '25512','55789','27556','16107','22451',
                          '48406','12824','35181','25021','78940',
                          '36619','74156','11899','75727'))
     intersect
     (select ca_zip
...
select  i_item_desc 
 ...
 and d_date between cast('2000-04-24' as date) 
 				and (cast('2000-04-24' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-19' as date) and (cast('2002-01-19' as date) +  60 days)
 and i_manufact_id in (482,136,619,575)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glenwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  69220
   and ib_upper_bound   <=  69220 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('steel','cyan','cornsilk'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 5
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2002-02-09' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-02-09' as date) - 30 days)
                and (cast ('2002-02-09' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (11,3,2,6,1,4) and
       d_year = 1999 and
       ca_state in ('MO','OK','IA'
                   ,'TX','NJ','IN','AR')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('KY', 'NC', 'WA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'SD', 'MD')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'GA', 'MT')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-04-11','2001-08-02','2001-11-21')))
