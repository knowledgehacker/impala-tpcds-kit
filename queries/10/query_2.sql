...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('ivory','burnished','white'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-01-14','1999-09-05','1999-11-17')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 181 and 181+10 
             or ss_coupon_amt between 15971 and 15971+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 182 and 182+10
          or ss_coupon_amt between 5497 and 5497+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 115 and 115+10
          or ss_coupon_amt between 14310 and 14310+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 74 and 74+10
          or ss_coupon_amt between 6148 and 6148+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 52 and 52+10
          or ss_coupon_amt between 12777 and 12777+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '89347','98267','26369','44729','90832','89722',
                          '36638','52836','39445','53519','90353',
                          '96449','44443','71742','96343','57293',
                          '14938','94907','94747','96642','54649',
                          '59047','10021','27788','33036','97420',
                          '10679','54731','50962','85950','60920',
                          '54760','76803','49817','57805','43056',
                          '78076','72976','84279','89557','66276',
                          '46471','22020','43318','80185','57753',
                          '38940','47035','42254','62980','37462',
                          '19160','85378','33553','50158','27766',
                          '24159','47231','50598','56072','84657',
                          '45481','21236','34423','42195','25782',
                          '14391','60300','86384','80000','10692',
                          '31324','19443','45576','53048','67424',
                          '34510','34914','94032','53231','87673',
                          '17698','73567','75697','76043','42998',
                          '57101','28342','66898','19667','60216',
                          '72610','27290','71542','39530','77550',
                          '11582','34120','76925','15895','64958',
                          '79060','18102','76417','88343','33433',
                          '76151','79875','19709','22088','60978',
                          '52054','96459','15836','28102','41236',
                          '20440','27067','12097','58248','44768',
                          '72786','13627','62630','66092','36273',
                          '99329','33195','87884','65364','96922',
                          '34352','40608','45583','37153','97302',
                          '18508','87840','56317','83176','92695',
                          '46125','16304','15641','12421','34829',
                          '49064','72437','72490','95981','21173',
                          '64915','48537','55309','44565','15208',
                          '89075','80284','91248','32032','31470',
                          '95418','21848','48804','53074','25263',
                          '97803','99926','94630','88610','25817',
                          '36036','79794','17919','14086','75517',
                          '64740','50391','41073','42276','80101',
                          '40222','89429','27243','82230','47151',
                          '36960','51536','65921','40148','82084',
                          '26710','51935','30664','70284','68674',
                          '53538','38121','76510','49503','95585',
                          '54231','13164','64696','41710','78459',
                          '58665','66195','65870','86350','27094',
                          '32486','93369','51440','57517','20612',
                          '36782','53243','34848','20201','94022',
                          '90219','63841','44379','56994','87140',
                          '51359','93791','49525','91371','70535',
                          '16325','25441','61205','99353','13747',
                          '89864','45108','19506','55810','55260',
                          '61680','37437','73693','76657','80738',
                          '41922','61768','17727','17596','82282',
                          '33341','52293','58349','82585','29021',
                          '47131','33808','34415','63823','74305',
                          '22082','24753','19987','80978','43107',
                          '64937','61548','28976','73383','22427',
                          '28870','35506','31589','52859','78764',
                          '77648','35481','83326','33967','25733',
                          '52023','46173','89191','68447','15286',
                          '79796','74172','33688','90657','56122',
                          '59848','53427','90795','70780','21295',
                          '80398','17681','46183','14656','40520',
                          '61158','26796','34432','76808','40159',
                          '33271','64778','31717','10053','15238',
                          '16942','11775','31331','39834','94654',
                          '26184','15274','67513','78234','61787',
                          '42877','26836','16205','17469','59562',
                          '25605','33170','52236','15761','33579',
                          '23662','61319','10912','54451','94603',
                          '94908','21607','19501','29065','63022',
                          '52784','23784','38790','66100','28502',
                          '93146','74011','67327','44739','33575',
                          '51653','24151','84877','77075','87594',
                          '38000','77335','67995','29375','23756',
                          '32757','42006','63733','48709','12380',
                          '51770','32451','30308','60277','38822',
                          '60169','93982','28742','66884','24368',
                          '16377','42003','37909','85800','64603',
                          '37180','43256','54579','53295','45035',
                          '49579','46710','25819','12137','75122',
                          '19882','31800','40396','23400','76035',
                          '19579','92840','12364','51382'))
     intersect
     (select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Cape May County','Lake County','Moore County','Orange County','Putnam County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('2001-02-01' as date) and (cast('2001-02-01' as date) +  60 days)
 and i_manufact_id in (323,660,343,169)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-02-19' as date) - 30 days)
                and (cast ('2002-02-19' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Union'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  4639
   and ib_upper_bound   <=  4639 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-06-07' as date) and (cast('2000-06-07' as date) +  60 days)
 and i_manufact_id in (916,791,969,750)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('2000-05-11' as date) 
				and (cast('2000-05-11' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('bisque','cornsilk','frosted','azure','medium','smoke') and
...
select  i_item_desc 
 ...
 and d_date between cast('2000-01-24' as date) 
 				and (cast('2000-01-24' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 84834
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 321853
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 415288
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 459607
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 463985
            then (select avg(ss_ext_list_price)
                  from store_sales
...
and d_date between '1999-03-10' and 
        (cast('1999-03-10' as date) + 90 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,4,11,5,1,9) and
       d_year = 1998 and
       ca_state in ('GA','FL','TX'
                   ,'VA','OK','IL','MN')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TX', 'VA', 'NJ')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OR', 'MO', 'GA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SD', 'OK', 'NE')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 723 and 723+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'hot' or i_color = 'lavender') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'tomato' or i_color = 'chartreuse') and
...
and d_date between '2000-03-17' and 
        (cast('2000-03-17' as date) + 90 days)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Riverside','Pleasant Hill','Midway','Oak Grove','Five Points') 
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Women','Books','Electronics') and
          i_class in ('fragrances','arts','scanners')
         )
      or (i_category in ('Sports','Home','Shoes') and
          i_class in ('baseball','blinds/shades','womens') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'ZHOU' || ',' || 'ORIENTAL' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 44628 and 44628+28800 
 	and sm_carrier in ('ZHOU','ORIENTAL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
