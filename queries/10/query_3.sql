...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Men','Sports','Music') and
          i_class in ('pants','fitness','rock')
         )
      or (i_category in ('Children','Home','Women') and
          i_class in ('newborn','curtains/drapes','fragrances') 
        ))
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-11' as date) 
                  and (cast('2000-08-11' as date) +  30 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,6,7,1,9,4) and
       d_year = 2001 and
       ca_state in ('IL','NC','OR'
                   ,'MO','CO','VT','IN')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('coral','smoke','linen'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 4
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MS', 'GA', 'WA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'VT', 'HI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'IA', 'MA')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Ridge'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  68888
   and ib_upper_bound   <=  68888 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Long County','Hardin County','Seminole County','Dolores County','Walworth County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '54587','66727','95860','58409','89426','29433',
                          '20453','91221','58657','55418','20319',
                          '99123','56871','47415','73925','72684',
                          '80102','60936','13384','51324','16316',
                          '18508','56797','14172','77114','84317',
                          '29094','95538','51051','25679','82976',
                          '28938','77174','84053','13755','83342',
                          '63694','73088','80952','76465','78026',
                          '47050','98394','20471','66331','71110',
                          '65584','73843','50022','37670','95081',
                          '82289','59933','28378','24562','22994',
                          '83215','43740','74481','30391','31076',
                          '85979','64377','68011','81228','20247',
                          '24303','14868','93879','68243','49488',
                          '14703','29263','92325','58855','10381',
                          '90107','10070','17644','59906','74766',
                          '61821','51344','78132','36626','88376',
                          '59316','70433','61618','53024','87501',
                          '70480','67038','16222','57228','86352',
                          '99975','92432','65559','83235','24083',
                          '45161','75562','67715','24878','12911',
                          '77420','70940','57031','17983','26696',
                          '36616','57366','46965','81892','94714',
                          '35158','50749','70495','97681','23810',
                          '65511','42332','89798','97795','75995',
                          '27345','54308','98943','95479','79597',
                          '93107','52498','38478','80260','29025',
                          '93451','57754','27049','40133','92480',
                          '57054','51470','93784','76461','63687',
                          '82102','23555','49758','38024','84537',
                          '15057','54427','36676','92840','39702',
                          '52337','21963','47820','76413','66826',
                          '40360','10716','59333','69623','19305',
                          '63226','28793','65948','35244','95394',
                          '58412','30747','19319','38968','87539',
                          '93506','64472','20795','79850','29242',
                          '53674','26977','68445','15514','69803',
                          '64177','57836','12174','12479','52485',
                          '47375','95176','66465','13677','29135',
                          '88141','91724','79494','33325','88811',
                          '84098','66159','40855','27991','62513',
                          '78155','70496','26896','67853','92843',
                          '37594','32773','76485','47356','43726',
                          '84651','54775','17008','11867','34434',
                          '63728','72313','29617','68663','95534',
                          '50458','61566','93126','57335','60710',
                          '22537','51139','98763','23368','68552',
                          '46430','61873','97086','21508','14983',
                          '25525','33408','78818','90348','49537',
                          '79071','93643','72268','49730','98840',
                          '43784','67600','92746','83804','11947',
                          '58094','43905','79983','33452','20251',
                          '10475','24643','38691','19012','49826',
                          '22720','66909','90020','63444','65579',
                          '75544','38470','37428','46230','41264',
                          '42378','92433','88652','41458','50280',
                          '93828','49883','88200','31449','20918',
                          '62734','11421','97127','60488','88609',
                          '17712','31472','66724','76510','80992',
                          '12378','23531','14452','60563','35894',
                          '49527','97868','94791','11143','67448',
                          '99672','25322','42688','22955','61887',
                          '59436','63933','98228','99255','17906',
                          '63520','11945','63493','48278','24575',
                          '13715','82220','48141','66674','65739',
                          '54985','13521','68698','62637','39530',
                          '18155','93656','75016','46662','29966',
                          '92033','20358','57344','24704','43443',
                          '19502','83933','75754','93484','67702',
                          '62063','91304','18930','68014','20759',
                          '18010','96455','61995','74782','93667',
                          '99791','66099','49086','62735','51503',
                          '98777','53501','38735','55325','86968',
                          '41188','20861','83896','90797','35564',
                          '98989','35443','41168','51421','96604',
                          '86177','40351','43320','59655','58896',
                          '43453','81170','79514','93087','78027',
                          '11417','89262','18725','93523','20212',
                          '52227','26831','33825','95526','88753',
                          '25982','12630','43076','30271'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('2001-06-26' as date) and (cast('2001-06-26' as date) +  60 days)
 and i_manufact_id in (803,712,835,668)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 36985 and 36985+28800 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2001-06-12' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2001-06-12' as date) - 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-02-02' as date) and (cast('2002-02-02' as date) +  60 days)
 and i_manufact_id in (435,907,671,54)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Riverside','Oak Grove','Midway','Fairview','Pleasant Hill') 
 ...
 where i_manufact_id between 830 and 830+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'smoke' or i_color = 'antique') and
        ...
        (i_category = 'Men' and
        (i_color = 'red' or i_color = 'purple') and
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2002-06-20' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-06-20' as date) - 30 days)
...
and d_date between '1998-03-29' and 
        (cast('1998-03-29' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-02-16','2001-08-31','2001-11-16')))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 99 and 99+10
          or ss_coupon_amt between 11017 and 11017+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 107 and 107+10
          or ss_coupon_amt between 2190 and 2190+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 5 and 5+10
          or ss_coupon_amt between 15538 and 15538+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 98 and 98+10
          or ss_coupon_amt between 5079 and 5079+1000
...
where 
	...
	and d_date between cast('2002-04-24' as date) 
				and (cast('2002-04-24' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('coral','powder','antique','puff','khaki','rose') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 131618
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 73749
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 133019
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 45629
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 244022
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2000-04-14' as date) 
				and (cast('2000-04-14' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-08' as date) 
                  and (cast('2000-08-08' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1998-05-14' as date) 
 				and (cast('1998-05-14' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
