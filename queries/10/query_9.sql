...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-22' as date) 
                  and (cast('2000-08-22' as date) +  14 days)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Crossroads'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  21273
   and ib_upper_bound   <=  21273 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('AR', 'WV', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'VA', 'CA')
...
and d_date between '2000-03-04' and 
        (cast('2000-03-04' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 275791
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 151552
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 496
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 162361
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 63286
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	...
	and d_date between cast('1998-06-22' as date) 
				and (cast('1998-06-22' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 24 and 24+10 
             or ss_coupon_amt between 7888 and 7888+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 168 and 168+10
          or ss_coupon_amt between 17 and 17+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 7 and 7+10
          or ss_coupon_amt between 1374 and 1374+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 187 and 187+10
          or ss_coupon_amt between 360 and 360+1000
...
select  i_item_id
 ...
 and d_date between cast('2001-05-16' as date) and (cast('2001-05-16' as date) +  60 days)
 and i_manufact_id in (544,481,676,986)
...
select  
 ...
 where
  ...
  ca_county in ('Texas County','Pulaski County','Gooding County','Red Willow County','Jefferson County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,5,8,10,12,3) and
       d_year = 2002 and
       ca_state in ('TN','AL','IN'
                   ,'GA','ID','KS','LA')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-04-25' as date) - 30 days)
                and (cast ('2002-04-25' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 57098 and 57098+28800 
...
where 
	...
	and d_date between cast('1998-03-24' as date) 
				and (cast('1998-03-24' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Men','Electronics','Books') and
          i_class in ('shirts','automotive','mystery')
         )
      or (i_category in ('Home','Music','Children') and
          i_class in ('blinds/shades','classical','newborn') 
        ))
 ...
 where i_manufact_id between 727 and 727+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'snow' or i_color = 'sky') and
        (i_units = 'Cup' or i_units = 'Unknown') and
        (i_size = 'large' or i_size = 'extra large')
        ) or
        (i_category = 'Men' and
        (i_color = 'antique' or i_color = 'blanched') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-07-01','2002-09-15','2002-11-07')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Oak Grove','Fairview','Midway','Riverside','Five Points') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('bisque','turquoise','purple','honeydew','pink','maroon') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('brown','tan','lawn'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 3
...
select  i_item_id
 ...
 and i_manufact_id in (792,961,833,960)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '76926','18050','51263','60119','40859','75243',
                          '66199','30088','96674','16718','21460',
                          '83327','99987','53193','37298','40924',
                          '35607','78649','90388','49961','33419',
                          '75987','34091','90708','24452','84467',
                          '12362','55586','76673','57161','69543',
                          '98817','47566','49735','62102','20418',
                          '91351','32280','41795','41816','10101',
                          '80438','80927','82028','96448','18431',
                          '95531','72677','12805','31019','32843',
                          '12050','61050','37782','92538','67470',
                          '40512','58017','78670','21509','39741',
                          '43934','28031','38939','23142','59993',
                          '94353','71581','90207','25038','48195',
                          '97077','23098','78361','64353','24000',
                          '59824','85645','99637','67679','79802',
                          '24833','86705','61322','16618','47437',
                          '95456','23259','41791','99667','68193',
                          '88461','46832','77458','16389','12938',
                          '17374','35901','27900','70296','98902',
                          '32018','18463','97412','79696','71485',
                          '82197','34257','46597','24364','52435',
                          '17304','53011','79051','81653','70647',
                          '48074','69496','80469','50817','19192',
                          '81969','83132','26719','30773','35388',
                          '62151','53985','10228','39856','69015',
                          '17802','49002','62543','95201','30879',
                          '55129','96484','67764','93686','17844',
                          '22241','47261','81993','45849','52475',
                          '31878','12350','79508','67676','78757',
                          '22941','90966','76241','96620','88537',
                          '64451','90492','74290','31413','43886',
                          '29873','37464','37722','15950','40432',
                          '85295','20367','44598','47046','72811',
                          '86353','80238','36311','80994','87715',
                          '23674','57369','84174','14270','59337',
                          '83822','13211','97531','20197','56288',
                          '69601','84776','27743','31860','18429',
                          '83965','80139','66907','48500','60357',
                          '27618','58455','15515','65172','88662',
                          '69547','34432','49580','87253','49301',
                          '47054','26308','45683','13794','20964',
                          '91025','53738','18665','64018','13807',
                          '90314','80558','23140','87385','61493',
                          '31292','71793','83585','63285','17847',
                          '91647','27144','39270','81338','38684',
                          '91266','44254','35718','38446','96943',
                          '20911','40199','62878','90681','21981',
                          '96955','19884','98159','43497','86363',
                          '30466','52388','52584','90042','44796',
                          '44086','76367','76277','56266','33924',
                          '96150','20681','43188','19669','92190',
                          '23749','74979','13189','63952','44834',
                          '10089','59376','11898','48573','57975',
                          '71824','58380','75374','78855','73141',
                          '37076','46097','76577','42581','26158',
                          '94384','78377','76064','32098','19264',
                          '37548','43471','15449','20649','11543',
                          '61343','63453','50975','87232','58364',
                          '47170','94438','65615','67937','55237',
                          '60131','94655','71429','82935','82682',
                          '32317','49446','34403','87181','34565',
                          '30443','43550','65980','33315','17813',
                          '52573','14449','69608','49106','66172',
                          '89097','36147','53776','35012','32491',
                          '38084','14562','69642','48733','63280',
                          '65895','90462','12976','28081','44303',
                          '79465','47069','72236','24500','13664',
                          '75609','18749','24205','52069','86808',
                          '77885','91638','18438','72079','93987',
                          '50231','73529','63140','18697','53964',
                          '41952','56345','78427','81952','49051',
                          '90319','50287','47868','40701','92641',
                          '34426','28079','77357','81330','50808',
                          '38305','22943','40660','60415','65620',
                          '96349','42771','35018','30164','86043',
                          '53917','15828','91034','31582','28434',
                          '19304','16788','56762','23458','66588',
                          '35192','90845','31276','57928','95290',
                          '96277','82467','82018','41200'))
     intersect
     (select ca_zip
