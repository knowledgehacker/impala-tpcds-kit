...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('burnished','purple','thistle'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-05-28','1998-09-09','1998-11-06')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 5 and 5+10 
             or ss_coupon_amt between 6258 and 6258+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 12497 and 12497+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '87422','32859','25096','68466','57900','91631',
                          '23806','67739','70842','11304','45278',
                          '78784','98299','72537','15224','13652',
                          '51767','39435','89504','53548','72661',
                          '47041','10434','63003','14583','19329',
                          '18704','35860','14081','62721','57204',
                          '72814','46501','21384','99140','21563',
                          '98587','68426','14885','94836','26695',
                          '59193','40161','63304','49394','14319',
                          '62321','98145','77867','75980','10382',
                          '31022','98736','22640','11148','99485',
                          '71936','90841','11145','94188','32937',
                          '36314','69583','23409','48857','48649',
                          '68621','11910','17365','18324','49582',
                          '36918','99684','34843','64743','99481',
                          '94045','29512','32639','46782','34118',
                          '41027','71998','55919','85845','86528',
                          '83594','46542','73087','99120','27726',
                          '56398','51942','65944','20191','47564',
                          '84162','66876','61367','49995','49690',
                          '80617','43617','12320','23764','86560',
                          '43158','13970','41941','84256','89878',
                          '85118','47076','64820','97915','24874',
                          '38034','78381','29891','51074','75929',
                          '13915','93415','76597','39320','62706',
                          '28259','73253','77981','80087','98790',
                          '78329','19823','58782','44391','13198',
                          '21498','78420','79285','21747','28537',
                          '34800','73544','63214','88238','53317',
                          '72019','80851','51758','38126','34847',
                          '91731','33365','95546','17529','70525',
                          '61204','49202','81206','27014','22286',
                          '53402','30090','67940','32562','41269',
                          '47389','11813','74500','63624','71905',
                          '22257','91759','10493','58858','41932',
                          '69283','61102','15607','20326','87440',
                          '11482','90823','74406','28243','63082',
                          '42650','35045','94768','15816','73899',
                          '66698','76951','99394','32045','44028',
                          '29524','28636','78878','74595','87228',
                          '81407','50815','23144','44344','66058',
                          '73337','73823','70880','49947','27697',
                          '56586','59596','90224','63627','64716',
                          '79396','68381','80630','28366','77811',
                          '87822','57619','87732','30134','96385',
                          '83604','55219','14057','81281','93669',
                          '47548','30246','89119','77742','81726',
                          '80562','78461','81187','44452','92651',
                          '19458','74960','65816','12472','50049',
                          '82069','66542','49492','68867','16418',
                          '24540','78039','99938','37404','77111',
                          '98002','37354','89401','76876','91421',
                          '54688','34617','25466','29570','15627',
                          '87629','46035','93079','63344','33224',
                          '95473','97012','93211','98652','87454',
                          '77349','19425','47748','52593','87340',
                          '16498','95668','45508','35094','84165',
                          '85598','31683','33215','41615','75314',
                          '66715','41603','96364','55411','29731',
                          '89945','83872','29610','75466','43111',
                          '58037','35307','78370','41947','46313',
                          '53438','98385','40613','17591','92898',
                          '60642','74034','97654','70179','60659',
                          '83702','76696','87726','35926','67261',
                          '44293','12583','98997','84347','32970',
                          '58448','56936','15974','95250','26282',
                          '54156','25557','17985','18603','89346',
                          '45328','51088','84370','32486','19260',
                          '13476','35425','26198','52491','83145',
                          '18732','30565','18150','79353','39233',
                          '19529','36886','88397','64481','27111',
                          '34655','80904','70853','24331','17456',
                          '34905','24415','61523','40878','17363',
                          '30047','34623','10240','85189','14860',
                          '17354','58338','33459','59838','31179',
                          '59576','85502','43331','63224','51215',
                          '90871','18256','86261','41278','78884',
                          '24019','60984','50495','64262','70429',
                          '96419','49184','27426','37097','54014',
                          '34718','20334','34447','31408'))
     intersect
     (select ca_zip
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-04' as date) 
                  and (cast('2001-08-04' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-06-27' as date) - 30 days)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Canadian County','Blaine County','McLean County','Amador County','Halifax County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('1999-01-16' as date) and (cast('1999-01-16' as date) +  60 days)
 and i_manufact_id in (531,323,311,312)
...
and cc_county in ('Williamson County','Fairfield County','Franklin Parish','Barrow County',
                  'Luce County'
)
and exists (select *
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-05-27' as date) - 30 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Barrow County','Luce County','Franklin Parish','Daviess County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Crossroads'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  46634
   and ib_upper_bound   <=  46634 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-02-21' as date) and (cast('1998-02-21' as date) +  60 days)
 and i_manufact_id in (836,970,718,785)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2002-05-28' as date) 
				and (cast('2002-05-28' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('powder','orange','snow','tan','firebrick','brown') and
...
select  i_item_desc 
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Electronics', 'Books', 'Home')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2002-01-31' as date) 
 				and (cast('2002-01-31' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 432399
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 478563
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 3808608
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1593410
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 298919
            then (select avg(ss_ext_list_price)
                  from store_sales
...
and d_date between '2001-02-13' and 
        (cast('2001-02-13' as date) + 90 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,10,1,12,3,2) and
       d_year = 2000 and
       ca_state in ('AR','MN','LA'
                   ,'SD','OH','TX','KS')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Walker County','Franklin Parish','Williamson County','Ziebach County',
                           'Daviess County','Richland County','Luce County','Fairfield County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ID', 'VA', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'MS', 'IA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'MN', 'WI')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 927 and 927+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'slate' or i_color = 'beige') and 
        (i_units = 'Bundle' or i_units = 'Each') and
        (i_size = 'small' or i_size = 'economy')
        ) or
        (i_category = 'Women' and
        (i_color = 'spring' or i_color = 'honeydew') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Greenwood','New Hope','Midway','Mount Pleasant','Bethel') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Home','Music','Books') and
          i_class in ('kids','classical','reference')
         )
      or (i_category in ('Electronics','Men','Women') and
          i_class in ('automotive','pants','dresses') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 53131 and 53131+28800 
