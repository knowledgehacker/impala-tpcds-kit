...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Books','Jewelry','Electronics') and
          i_class in ('romance','bracelets','camcorders')
         )
      or (i_category in ('Children','Shoes','Home') and
          i_class in ('infants','kids','flatware') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,1,5,4,8,11) and
       d_year = 2001 and
       ca_state in ('VA','GA','CA'
                   ,'MS','PA','TX','NC')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','purple','magenta'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 3
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('CA', 'WI', 'MA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'NC', 'AK')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('LA', 'MS', 'MI')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Mount Zion'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  10498
   and ib_upper_bound   <=  10498 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Sitka Borough','Columbiana County','Schuyler County','Roger Mills County','Webster Parish') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '94934','37756','57210','32308','10716','36840',
                          '19259','35099','59195','93281','95108',
                          '62768','67803','10664','54184','67734',
                          '33828','88359','91238','66628','90746',
                          '41797','23603','33449','72056','64889',
                          '77968','22863','11639','59738','21616',
                          '74594','11812','81519','29428','15462',
                          '39747','98448','92564','47528','41156',
                          '34021','97796','98142','88424','39395',
                          '59693','94445','47112','68939','44913',
                          '72320','33026','65777','67433','29480',
                          '11425','30063','50410','15552','58782',
                          '76225','53799','60867','66909','46363',
                          '23774','49272','12663','85265','59034',
                          '13012','42171','12168','79420','77805',
                          '55587','66372','70031','81776','50272',
                          '78406','72728','52025','59201','78263',
                          '29102','90787','91360','54960','11658',
                          '99734','28353','85140','82910','81612',
                          '67231','47981','48305','79513','49838',
                          '81300','25637','95992','66094','46916',
                          '77586','97037','35595','62242','10445',
                          '48048','37711','21790','93674','94160',
                          '89682','46006','90692','59594','37702',
                          '86454','61116','66901','22871','72599',
                          '61735','35181','79254','93662','61572',
                          '52467','99141','42914','79845','21235',
                          '85548','37998','66286','19705','64736',
                          '21678','84341','55653','68643','99659',
                          '42124','78566','95546','76261','88260',
                          '58696','69075','34168','81713','57958',
                          '93545','26808','88611','47711','87789',
                          '31615','19499','71697','12318','82589',
                          '39996','69126','75112','33640','91278',
                          '27974','38390','55421','60910','34102',
                          '86857','65915','46494','26886','21589',
                          '28970','20220','93062','33473','23091',
                          '48003','66960','60242','55724','30764',
                          '87437','73695','13720','10867','25431',
                          '33595','85711','58380','48849','42419',
                          '97217','83781','50641','34144','67361',
                          '74132','60491','25248','63399','20316',
                          '89188','17436','43589','99753','47620',
                          '48537','88118','45892','71284','98840',
                          '52984','79284','60688','52335','82988',
                          '46133','95690','91275','69465','65495',
                          '26793','28873','68195','43480','62257',
                          '69007','24395','66863','94853','43077',
                          '89991','51634','32459','48929','62348',
                          '91179','12491','53219','53497','85481',
                          '86345','47224','43455','26455','37097',
                          '21275','68524','90821','11536','17939',
                          '86323','89964','30770','89405','30380',
                          '16644','34892','46661','15269','91739',
                          '39604','66674','98816','21098','42234',
                          '85420','61057','81502','52663','38131',
                          '49450','83075','81868','47658','48588',
                          '28472','17998','28894','28140','94407',
                          '23907','10461','82823','23480','67109',
                          '75767','96865','14015','83258','19523',
                          '91595','82045','69623','98885','29763',
                          '24583','69425','76669','13698','30385',
                          '60917','91158','82236','73231','64049',
                          '90774','67722','62735','68208','54271',
                          '88241','38243','39756','19782','28287',
                          '11389','78627','74720','31153','62716',
                          '13059','31294','41868','26327','86393',
                          '21848','38463','14836','78549','20090',
                          '33029','67765','67221','29875','54747',
                          '10132','94588','28615','43769','44164',
                          '50448','58839','85145','84951','84807',
                          '22444','84195','57406','21494','33161',
                          '56368','29135','97044','96198','34117',
                          '14333','79398','53618','87507','49417',
                          '38741','34587','66142','82692','80746',
                          '83226','81581','85398','67052','33375',
                          '53856','96299','60285','13569','32864',
                          '25087','73110','81051','87182','23289',
                          '89960','22235','48145','47205','43388',
                          '54602','16292','81439','68685'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('2000-06-28' as date) and (cast('2000-06-28' as date) +  60 days)
 and i_manufact_id in (959,874,725,917)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 32967 and 32967+28800 
...
select  i_item_id
 ...
 and i_manufact_id in (398,693,276,571)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Union','New Hope','Midway','Pleasant Valley','Salem') 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 723 and 723+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'thistle' or i_color = 'linen') and 
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-04-22' as date) - 30 days)
...
and cc_county in ('Daviess County','Walker County','Luce County','Richland County',
                  'Williamson County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Franklin Parish','Ziebach County','Daviess County','Richland County',
                           'Walker County','Barrow County','Luce County','Fairfield County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Midway','Salem')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-01-31','2001-09-17','2001-11-15')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 58 and 58+10
          or ss_coupon_amt between 4551 and 4551+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 67 and 67+10
          or ss_coupon_amt between 5969 and 5969+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 13212 and 13212+1000
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Sports', 'Children', 'Men')
  	and ws_sold_date_sk = d_date_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('frosted','burlywood','blush','orchid','medium','bisque') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1084958
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 289984
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1961939
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 653476
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1246328
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
and d_date between '2002-01-22' and 
        (cast('2002-01-22' as date) + 90 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Walker County','Barrow County','Richland County','Luce County')
