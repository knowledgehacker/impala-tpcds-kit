...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Jackson'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  69867
   and ib_upper_bound   <=  69867 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('KY', 'OK', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'SC', 'NE')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'DE', 'WI')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Luce County','Walker County','Daviess County',
                           'Franklin Parish','Williamson County','Richland County','Barrow County')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-04-15' as date) - 30 days)
                    and (cast ('2000-04-15' as date) + 30 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 3356124
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4091975
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1971335
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 2196139
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 4777994
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	...
	and d_date between cast('2000-04-20' as date) 
				and (cast('2000-04-20' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2000-02-24' and 
        (cast('2000-02-24' as date) + 90 days)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 74 and 74+10 
             or ss_coupon_amt between 1723 and 1723+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 7775 and 7775+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 177 and 177+10
          or ss_coupon_amt between 9015 and 9015+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 91 and 91+10
          or ss_coupon_amt between 11039 and 11039+1000
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2000-06-22' as date) 
 				and (cast('2000-06-22' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and i_manufact_id in (236,871,218,987)
...
and cc_county in ('Barrow County','Daviess County','Richland County','Fairfield County',
                  'Williamson County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Duchesne County','Humboldt County','Dickinson County','Jim Wells County','Beaver County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,6,2,4,3,11) and
       d_year = 2001 and
       ca_state in ('KY','NC','WI'
                   ,'LA','IA','MN','NE')
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-17' as date) 
                  and (cast('1999-08-17' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Union','Liberty')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-31' as date) - 30 days)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 7050 and 7050+28800 
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Williamson County','Walker County','Fairfield County','Luce County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Music','Home','Sports') and
          i_class in ('pop','bathroom','baseball')
         )
      or (i_category in ('Jewelry','Men','Books') and
          i_class in ('consignment','accessories','reference') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 855 and 855+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'chartreuse' or i_color = 'blanched') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-05-12','2001-08-18','2001-11-22')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Riverside','Pleasant Valley','Liberty','Oakland','Centerville') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','sienna','chiffon','orchid','blanched','sandy') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('violet','navajo','sandy'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 2
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-01-11' as date) and (cast('1998-01-11' as date) +  60 days)
 and i_manufact_id in (768,954,916,951)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '15797','32149','67240','28389','18689','37973',
                          '84094','51087','71831','57108','84297',
                          '33967','83985','43396','77413','88587',
                          '75057','11256','18746','30309','70135',
                          '81430','78205','47026','53088','88267',
                          '40111','22016','94741','15972','73623',
                          '97234','80474','49751','76739','70238',
                          '74633','91353','63697','53672','25119',
                          '41695','63767','74760','95030','94751',
                          '74081','34668','47055','25533','28047',
                          '91402','36919','87334','40344','83619',
                          '51000','79594','97975','57922','27904',
                          '10896','12801','77830','84288','16850',
                          '76070','29591','26683','40739','94619',
                          '54135','98514','25009','62571','28023',
                          '75943','22493','91212','41698','89853',
                          '77257','54548','72476','69064','90399',
                          '95132','77973','58253','72498','40695',
                          '81098','38181','57109','95683','69277',
                          '92380','91083','57058','75666','54014',
                          '75332','42503','25221','25797','87295',
                          '94337','52462','99520','34239','91275',
                          '84195','80104','18935','93069','64864',
                          '98990','72802','24074','94467','58709',
                          '23518','34745','75319','12640','17948',
                          '69552','61601','54080','90643','95373',
                          '73968','88232','51491','35880','38650',
                          '42087','19212','69121','25721','12276',
                          '92327','86137','42927','31950','50341',
                          '74873','24523','42731','88403','44021',
                          '11939','86526','35403','35227','56438',
                          '74629','17142','78182','53029','11901',
                          '84501','83782','76300','61350','56257',
                          '82729','63579','10690','63103','32463',
                          '93196','25877','16230','19438','92486',
                          '27111','64296','13186','12819','99174',
                          '57603','26972','12040','83961','97011',
                          '95435','40748','68745','60337','85469',
                          '17870','61962','11326','74229','35768',
                          '36637','24746','28886','95059','35440',
                          '29903','22628','53059','59815','13222',
                          '21915','36929','97168','15534','31359',
                          '62036','22147','33641','98724','94995',
                          '12837','44873','63008','46803','22569',
                          '95715','81123','25614','81245','23330',
                          '93081','54194','21539','33099','87986',
                          '94069','60395','28343','27193','44253',
                          '58950','67976','89765','25502','66387',
                          '51486','98060','34979','48312','26691',
                          '64884','20659','57629','52529','14189',
                          '34168','40631','21959','23126','47774',
                          '17663','19806','67731','89758','28391',
                          '13871','10224','56411','47537','51923',
                          '27553','74344','78976','34814','94914',
                          '22649','50265','17139','51223','24696',
                          '89009','55046','78756','40381','18954',
                          '31252','55357','95759','15767','63514',
                          '29979','73728','46402','43387','87525',
                          '80588','59365','62583','31825','53669',
                          '81310','80250','75745','89812','49300',
                          '16808','12175','26321','56565','39456',
                          '23437','78531','75790','39171','41494',
                          '91756','54299','76942','80839','32448',
                          '44197','60458','16098','14532','20373',
                          '44215','39495','32387','44115','44345',
                          '29569','11894','43237','96070','72202',
                          '19720','12910','44216','62897','54400',
                          '82382','25771','93046','20322','93779',
                          '21798','62053','27848','80785','41440',
                          '71277','31660','53979','81793','91728',
                          '12786','38120','50793','94691','53398',
                          '77190','90168','58683','14649','17977',
                          '94149','47493','83677','99500','52164',
                          '86847','69046','11749','74548','51998',
                          '18130','34832','21116','59433','28233',
                          '20681','28773','66166','93796','13842',
                          '74316','36557','57426','79022','50372',
                          '96044','88990','71803','68507','32397',
                          '67388','22558','57476','86591','10985',
                          '24598','62702','70214','96642'))
     intersect
     (select ca_zip
