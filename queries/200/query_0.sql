...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-04-08' as date) - 30 days)
                    and (cast ('2000-04-08' as date) + 30 days)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('indian','linen','frosted','firebrick','midnight','goldenrod') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Fairview','Midway','Five Points','Mount Pleasant','Pleasant Hill') 
...
and cc_county in ('Walker County','Fairfield County','Williamson County','Ziebach County',
                  'Ziebach County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Mahaska County','Archer County','Oldham County','Tillamook County','Bingham County') and
...
select  i_item_id
 ...
 and d_date between cast('2001-03-31' as date) and (cast('2001-03-31' as date) +  60 days)
 and i_manufact_id in (687,863,838,917)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 36 and 36+10 
             or ss_coupon_amt between 6220 and 6220+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 60 and 60+10
          or ss_coupon_amt between 10327 and 10327+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 140 and 140+10
          or ss_coupon_amt between 10276 and 10276+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 50 and 50+10
          or ss_coupon_amt between 4153 and 4153+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 635 and 635+1000
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'BARIAN' || ',' || 'PRIVATECARRIER' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 135 and 135+28800 
 	and sm_carrier in ('BARIAN','PRIVATECARRIER')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
and d_date between '2001-03-07' and 
        (cast('2001-03-07' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 9347008
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4567595
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 7859088
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 633663
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 7442951
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Books','Music','Shoes') and
          i_class in ('parenting','country','womens')
         )
      or (i_category in ('Men','Sports','Children') and
          i_class in ('shirts','guns','infants') 
        ))
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '62909','45572','69007','25608','94867','99226',
                          '96760','12968','41740','90495','39163',
                          '95929','46297','66382','32387','70575',
                          '66468','19950','49604','32917','87451',
                          '50487','29337','37717','37400','65060',
                          '65823','63776','35805','59565','27978',
                          '83952','38080','24565','37855','13170',
                          '26159','67536','85242','94187','61363',
                          '69979','14287','59849','48098','94203',
                          '66147','62187','84923','31281','76742',
                          '55363','37608','74461','38086','74157',
                          '40539','27343','58166','20491','53300',
                          '79038','43764','25550','99848','15927',
                          '28835','32110','39422','81165','42344',
                          '81222','28115','21374','99717','37874',
                          '79269','34398','12557','70144','45044',
                          '13311','23077','25062','11665','31815',
                          '20588','21805','56097','19630','23116',
                          '53730','63482','60197','15747','50940',
                          '61683','12860','26414','11113','55512',
                          '15239','99819','38324','99924','70043',
                          '93080','35743','58185','22601','74474',
                          '55008','43919','31284','32765','65703',
                          '11291','96063','57612','13935','84418',
                          '93417','12473','65569','47955','58602',
                          '87968','12940','10445','23503','81291',
                          '36744','30268','46839','94160','46270',
                          '90668','14064','36858','12841','14750',
                          '35204','11723','11889','64866','13400',
                          '61275','63925','51123','32960','77324',
                          '30581','82484','22511','96556','41039',
                          '92038','77047','60993','76810','19368',
                          '66205','64109','84739','25371','66469',
                          '69379','53196','13406','75605','51673',
                          '38989','76636','53553','38061','91973',
                          '97162','17054','98794','32078','77571',
                          '70960','19816','15943','15069','95588',
                          '34294','42350','14507','36727','14388',
                          '55088','66854','10386','73410','27796',
                          '77018','39984','75023','32398','12056',
                          '83872','23519','47993','20901','15804',
                          '42844','66146','28838','27521','35143',
                          '75044','29370','35873','77843','11521',
                          '61486','22296','76644','94415','50106',
                          '20961','64311','14351','62308','37516',
                          '38916','25079','31733','73706','75521',
                          '91991','15751','58193','18213','33243',
                          '24507','30349','88642','22943','62667',
                          '78220','83546','72825','44098','57705',
                          '16474','75912','45070','28385','59277',
                          '19349','26421','53403','15542','14271',
                          '62556','27754','27230','10964','64257',
                          '58249','61614','61155','25195','62492',
                          '22159','18647','61071','94529','70660',
                          '89042','77916','62198','10551','14506',
                          '20322','13085','27348','63076','68076',
                          '23480','23193','87081','85944','48072',
                          '12975','20835','96827','78668','91944',
                          '63450','80309','76350','94639','22230',
                          '98857','22081','34764','91877','85167',
                          '42899','37383','95535','22731','79570',
                          '68129','92101','16739','46523','39157',
                          '57499','31968','45958','56262','24167',
                          '22393','18473','23504','19835','13212',
                          '77605','89066','59039','24825','41650',
                          '73810','27064','18933','90728','14581',
                          '54039','77465','15103','99233','54466',
                          '14869','43525','89578','18880','19873',
                          '74681','80469','61041','99136','30024',
                          '57804','73887','18280','62120','68850',
                          '69995','49917','79627','80057','88837',
                          '72957','15323','22975','77778','51609',
                          '11500','42834','77506','49906','78653',
                          '29147','85284','55372','31016','45787',
                          '86420','37040','54537','69437','18810',
                          '44569','10549','70447','58545','62540',
                          '65232','70436','10588','85896','13934',
                          '51489','12828','75789','81843','34202',
                          '94163','62221','74169','43765','67164',
                          '16554','53461','16713','57868'))
     intersect
     (select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Men', 'Children', 'Home')
  	and ws_sold_date_sk = d_date_sk
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2000-02-05' as date) 
 				and (cast('2000-02-05' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-14' as date) and (cast('1999-07-14' as date) +  60 days)
 and i_manufact_id in (214,567,617,807)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-17' as date) 
                  and (cast('2000-08-17' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Ashland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  52714
   and ib_upper_bound   <=  52714 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('moccasin','bisque','forest'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 2
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-06-18' as date) - 30 days)
                and (cast ('1999-06-18' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,3,9,5,12,6) and
       d_year = 2002 and
       ca_state in ('TX','MI','GA'
                   ,'MN','CO','KS','OK')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MN', 'SD', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'NC', 'KS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OH', 'VA', 'NY')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-04-29','1998-08-20','1998-11-11')))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-03' as date) 
                  and (cast('1999-08-03' as date) +  14 days)
