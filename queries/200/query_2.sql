...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('firebrick','lace','purple'))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-10' as date) 
                  and (cast('2001-08-10' as date) +  14 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-04-27','1998-10-10','1998-11-23')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 176 and 176+10
          or ss_coupon_amt between 10396 and 10396+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 20 and 20+10
          or ss_coupon_amt between 16575 and 16575+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 25 and 25+10
          or ss_coupon_amt between 1577 and 1577+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '14345','68329','20196','12485','64130','66141',
                          '39822','98397','66286','63225','11361',
                          '68539','30748','95966','58052','48283',
                          '24916','17513','53756','10965','71310',
                          '30070','38584','65697','30474','77943',
                          '43838','38383','61630','29719','43643',
                          '38524','96557','92180','52831','50719',
                          '94982','37625','57028','34276','77504',
                          '61815','54327','57785','85990','13344',
                          '98235','10807','99135','15170','44058',
                          '69568','94796','80528','12954','47476',
                          '76851','36351','11857','13152','37063',
                          '37607','38406','97780','10609','16300',
                          '69010','25739','40813','57659','64945',
                          '12641','75712','16503','28842','97730',
                          '54679','56746','41600','22056','27644',
                          '67913','46766','31873','30162','13106',
                          '28570','66284','60752','77856','80175',
                          '36524','95644','58379','97450','24324',
                          '84591','15489','33120','53675','18613',
                          '14187','78857','25736','81538','49240',
                          '44789','54158','79880','93538','14073',
                          '81804','39505','30480','47727','52395',
                          '30701','40342','20870','37296','63231',
                          '67598','50825','30659','66147','85640',
                          '58363','97898','53211','83397','95084',
                          '40949','36706','76855','52522','21507',
                          '92090','73832','30574','65631','41349',
                          '10671','58557','12957','53285','65001',
                          '78628','84026','89125','13105','39969',
                          '24428','73503','40148','43043','89324',
                          '26483','80132','69167','31740','70870',
                          '85212','30512','73908','31126','16591',
                          '57022','15025','72304','30175','99106',
                          '72742','46270','24528','61832','68500',
                          '88294','79090','26994','39120','68599',
                          '62304','97565','18767','94631','88597',
                          '56446','55859','85612','97657','40716',
                          '45563','77332','66199','17935','39748',
                          '18386','59406','36642','37335','69985',
                          '84969','96653','33573','63823','55554',
                          '22673','34864','75117','83911','63288',
                          '20633','48777','85766','15096','59164',
                          '68128','75990','13120','90191','45572',
                          '78219','99866','99641','57443','68676',
                          '13894','64023','81436','38690','37070',
                          '70077','97864','16062','62949','70165',
                          '95650','25429','82657','30213','33267',
                          '44345','16962','39874','89391','19658',
                          '13300','51182','37058','62262','30738',
                          '55463','83767','45599','18918','83635',
                          '20813','21146','14837','66777','57862',
                          '12358','74075','51189','89145','12843',
                          '15350','26863','67004','44743','38512',
                          '79768','45359','22424','52328','97378',
                          '62635','73350','30567','71682','76611',
                          '79202','80659','41236','95007','61427',
                          '78201','18861','90562','37297','34473',
                          '19482','94073','18614','23378','69105',
                          '20550','56470','58254','36278','34952',
                          '95384','13922','54860','44560','21346',
                          '30622','32155','67213','90336','37393',
                          '86505','92798','28306','21948','44919',
                          '73616','62708','62126','64256','98593',
                          '62141','29916','30063','41163','98256',
                          '55891','88333','58163','73994','76617',
                          '20610','40669','88375','91717','84525',
                          '48926','73421','74582','50930','92201',
                          '32626','45189','98553','79585','70040',
                          '87484','98777','92815','21871','52990',
                          '55462','44764','30500','86739','45840',
                          '21780','62504','42602','52918','60420',
                          '83919','78139','87136','40246','62650',
                          '23848','93183','68666','60176','86975',
                          '14683','60452','80594','21563','90173',
                          '57693','60204','66418','71704','97526',
                          '91384','79066','43263','25143','72530',
                          '87928','50419','36253','24747','67945',
                          '33117','54479','45291','50340','61770',
                          '51411','68221','18830','59886'))
     intersect
     (select ca_zip
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-12' as date) 
                  and (cast('1998-08-12' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Wilkes County','Clay County','Marion County','York County','Clallam County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and i_manufact_id in (962,613,352,981)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-03-31' as date) - 30 days)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Arlington'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  19695
   and ib_upper_bound   <=  19695 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-02-11' as date) and (cast('2002-02-11' as date) +  60 days)
 and i_manufact_id in (752,969,935,720)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('royal','slate','magenta','light','wheat','navajo') and
...
select  i_item_desc 
 ...
 and d_date between cast('2000-06-24' as date) 
 				and (cast('2000-06-24' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 8709942
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 1640119
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 2529786
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 2992657
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1966950
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
i_manufact_id = 185
and i_item_sk = cs_item_sk 
and d_date between '1998-02-26' and 
        (cast('1998-02-26' as date) + 90 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,6,4,5,11,7) and
       d_year = 2000 and
       ca_state in ('KY','NY','MS'
                   ,'GA','IN','ND','WI')
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Mount Pleasant','Midway','Five Points','Riverside','Fairview') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Books','Jewelry') and
          i_class in ('outdoor','travel','gold')
         )
      or (i_category in ('Home','Children','Men') and
          i_class in ('kids','newborn','accessories') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 6779 and 6779+28800 
 	and sm_carrier in ('DHL','USPS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
