...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Books','Men','Children') and
          i_class in ('reference','shirts','school-uniforms')
         )
      or (i_category in ('Electronics','Shoes','Home') and
          i_class in ('stereo','mens','tables') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-16' as date) 
                  and (cast('2001-08-16' as date) +  14 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,4,3,8,9,2) and
       d_year = 2001 and
       ca_state in ('KS','CT','GA'
                   ,'PA','WI','IA','SD')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('olive','lawn','slate'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 1
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('OK', 'VA', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'AK', 'ND')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'KY', 'NY')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wildwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  16926
   and ib_upper_bound   <=  16926 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Amador County','Rolette County','Carroll County','Billings County','Ouray County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '32086','17060','44093','58539','55969','34457',
                          '38618','65064','68034','75490','70216',
                          '92761','33071','20267','44175','45736',
                          '46559','39292','49869','57032','57597',
                          '32930','29640','66715','43307','74896',
                          '41074','15729','76249','95066','18303',
                          '39133','50224','33382','84223','79506',
                          '35342','60436','88705','15040','31913',
                          '90907','15048','87267','31457','24227',
                          '33118','29059','66693','57682','17751',
                          '21960','18141','41359','51813','72525',
                          '69862','78567','51714','69472','72681',
                          '97571','43617','22187','81153','36668',
                          '67676','24914','41563','58489','59384',
                          '76748','46615','75407','93672','32881',
                          '61749','77649','86885','94051','26442',
                          '49122','45095','95007','12230','57992',
                          '28383','80570','32555','54553','35306',
                          '31858','79195','54651','14920','13841',
                          '50589','21268','90722','46269','72617',
                          '99617','49768','71970','68812','86240',
                          '91258','72603','39037','32398','94135',
                          '75599','96844','75298','90548','30578',
                          '46106','39166','95739','99976','52366',
                          '26284','53619','42896','81725','41477',
                          '84683','99120','33776','35381','78308',
                          '59599','86270','78982','10215','60928',
                          '25082','43809','87944','82439','46316',
                          '72489','51440','67752','49282','31033',
                          '65814','49338','82718','21976','17621',
                          '68647','93951','74112','90030','57270',
                          '86014','68152','50158','84032','23556',
                          '25175','57884','82911','54144','58228',
                          '85499','49064','34826','45140','63132',
                          '91415','76167','53159','76425','72696',
                          '66896','58511','66853','30050','63072',
                          '91061','59546','81812','53943','12702',
                          '16820','64632','49425','55879','98959',
                          '19624','65367','29715','39427','87165',
                          '30732','45396','38956','19281','78588',
                          '95398','85859','60450','63119','39085',
                          '48098','53261','40461','86995','56198',
                          '43200','88697','96544','92371','61455',
                          '37287','93003','96368','64096','92569',
                          '90827','26904','72104','46608','85536',
                          '52665','96909','17659','35738','29495',
                          '76177','23033','63939','78591','51447',
                          '60315','97160','82399','46879','95491',
                          '13120','33867','93515','96365','94538',
                          '66838','64052','93914','16758','54261',
                          '59565','94648','96191','90405','21563',
                          '98366','31976','20834','91088','40219',
                          '77772','81561','77346','84593','76149',
                          '56620','23316','83769','70680','48975',
                          '92394','51705','56346','18379','89167',
                          '43367','69126','49934','70828','27781',
                          '67004','70311','51542','21831','45494',
                          '85769','56417','81117','99628','73422',
                          '74663','34900','83027','90717','71922',
                          '71895','56348','26209','76376','64609',
                          '63711','55074','88806','11860','83481',
                          '11935','63677','45433','59299','73357',
                          '30341','89454','93150','97664','28122',
                          '52197','64831','83359','68494','39248',
                          '35597','95281','20128','14697','73574',
                          '90165','60319','59151','97394','38810',
                          '45138','31817','32046','40622','49687',
                          '37736','84912','61757','12364','19720',
                          '75481','14645','43632','30335','20173',
                          '80138','90727','96199','31968','76913',
                          '80302','21067','11080','27073','84127',
                          '25527','34476','70500','20583','78523',
                          '75183','38833','81844','75202','47307',
                          '63919','36410','89641','74611','41818',
                          '97845','43156','97278','64533','20781',
                          '53241','90343','30526','10565','25533',
                          '43503','74981','35614','63250','33554',
                          '55583','34236','47242','50497','67324',
                          '31199','52900','63790','83863','27006',
                          '90390','58481','42175','30319'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('1999-02-03' as date) and (cast('1999-02-03' as date) +  60 days)
 and i_manufact_id in (667,931,820,790)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 41280 and 41280+28800 
...
select  i_item_id
 ...
 and i_manufact_id in (92,207,4,842)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Oak Grove','Five Points','Mount Pleasant','Pleasant Hill','Centerville') 
 ...
 where i_manufact_id between 960 and 960+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'sandy' or i_color = 'lavender') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-02-09' as date) - 30 days)
                and (cast ('2000-02-09' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and d_date between '1998-02-23' and 
        (cast('1998-02-23' as date) + 90 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Ziebach County','Fairfield County','Walker County','Williamson County',
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Centerville','Pleasant Hill')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-01-16','2001-08-18','2001-11-14')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 57 and 57+10 
             or ss_coupon_amt between 2470 and 2470+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 134 and 134+10
          or ss_coupon_amt between 9919 and 9919+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 5091 and 5091+1000
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1999-01-27' as date) 
				and (cast('1999-01-27' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('goldenrod','blush','burnished','seashell','lemon','maroon') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2069838
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 9140383
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 2502201
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 9327330
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 3190292
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('1999-03-25' as date) 
				and (cast('1999-03-25' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
