...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Lakewood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  24633
   and ib_upper_bound   <=  24633 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NE', 'GA', 'UT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'MD', 'TN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'TX', 'PA')
...
and d_date between '2002-03-23' and 
        (cast('2002-03-23' as date) + 90 days)
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1999-03-13' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1999-03-13' as date) - 30 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2721495
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 6081931
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 8774462
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 8770298
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 4984683
            then (select avg(ss_ext_list_price)
                  from store_sales
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Electronics', 'Women', 'Music')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2001-01-23' as date) 
				and (cast('2001-01-23' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 74 and 74+10 
             or ss_coupon_amt between 16199 and 16199+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 32 and 32+10
          or ss_coupon_amt between 1435 and 1435+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 125 and 125+10
          or ss_coupon_amt between 14630 and 14630+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 145 and 145+10
          or ss_coupon_amt between 1595 and 1595+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 150 and 150+10
          or ss_coupon_amt between 6470 and 6470+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 92 and 92+10
          or ss_coupon_amt between 2477 and 2477+1000
...
select  i_item_id
 ...
 and d_date between cast('1999-05-21' as date) and (cast('1999-05-21' as date) +  60 days)
 and i_manufact_id in (962,510,426,599)
...
and cc_county in ('Ziebach County','Walker County','Fairfield County','Williamson County',
                  'Ziebach County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Sedgwick County','Somerset County','Scott County','Perkins County','Smith County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,11,2,3,1,5) and
       d_year = 2002 and
       ca_state in ('MT','NC','AL'
                   ,'CO','MN','MS','OH')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-04-10' as date) - 30 days)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 27504 and 27504+28800 
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Walker County','Ziebach County','Fairfield County','Williamson County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Electronics','Home','Books') and
          i_class in ('karoke','wallpaper','fiction')
         )
      or (i_category in ('Shoes','Sports','Children') and
          i_class in ('womens','tennis','newborn') 
        ))
 ...
 where i_manufact_id between 719 and 719+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'sky' or i_color = 'puff') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-30','2001-09-16','2001-11-19')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Pleasant Hill','Fairview','Five Points','Midway','Centerville') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('powder','medium','chartreuse','misty','thistle','royal') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','aquamarine','powder'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 1
...
select  i_item_id
 ...
 and i_manufact_id in (811,698,935,753)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '73591','28699','86579','57891','23891','63243',
                          '12650','71450','94443','54369','91363',
                          '24847','45392','45808','12055','85775',
                          '11654','86968','21980','94195','79570',
                          '50254','94497','88973','16396','27626',
                          '43695','38714','52834','66409','71441',
                          '76925','60965','82516','45778','53621',
                          '76487','44448','90278','95294','21394',
                          '26183','91355','17440','15688','34934',
                          '40946','68095','84607','97628','72763',
                          '39671','58669','34558','99775','74075',
                          '90822','33500','23582','79306','60850',
                          '11729','69142','84013','23743','48814',
                          '14816','50746','60465','43179','30550',
                          '64248','41633','51688','22206','35233',
                          '53132','77725','86382','31427','66391',
                          '85596','37999','35794','23086','44301',
                          '17277','73024','30378','21757','89325',
                          '18255','93491','98047','30370','26242',
                          '87189','20298','16779','58426','78335',
                          '99014','92813','18396','52147','17240',
                          '88831','16846','87643','24166','49379',
                          '76717','36231','52636','86934','45230',
                          '31377','26999','59797','18619','77455',
                          '95286','77800','76914','81806','38492',
                          '27780','40440','19020','77398','98043',
                          '24060','30636','38087','68057','90218',
                          '98295','12345','24197','70924','80551',
                          '24923','97809','54675','65891','42385',
                          '50871','84261','54510','57734','23056',
                          '99151','93237','34578','21872','99322',
                          '50729','89474','89845','56232','43914',
                          '73141','97860','75099','10178','63399',
                          '67449','28249','57010','14225','41202',
                          '90624','62687','43666','45784','72201',
                          '16380','82065','58869','77271','32849',
                          '83378','99250','30170','89262','19333',
                          '57032','63171','44112','34001','87225',
                          '34655','58505','20431','59472','44874',
                          '40968','29288','82819','47436','67551',
                          '11039','44446','68634','25626','95233',
                          '14337','11144','29239','53885','12782',
                          '95417','95735','46743','27896','77585',
                          '65562','90744','36239','45098','43393',
                          '48980','80878','90946','85056','23309',
                          '16811','68302','98953','25150','20974',
                          '29641','76714','40846','90050','67777',
                          '23409','54186','83633','18393','46806',
                          '60720','96053','90729','29486','73118',
                          '98429','55716','12248','76177','50174',
                          '76982','42516','60681','67272','82866',
                          '69048','99356','85260','87469','57860',
                          '86648','15208','96141','11401','53079',
                          '52750','41949','64672','47168','68189',
                          '18983','95214','10442','20339','75342',
                          '97218','89532','18953','36869','38127',
                          '63524','12628','37723','26596','21955',
                          '18128','53259','92326','43087','21764',
                          '66962','47849','64845','42980','90792',
                          '76874','14251','70652','24640','27316',
                          '53644','34876','66107','81052','41310',
                          '10376','39752','74499','69243','82983',
                          '53602','50758','42487','15692','56990',
                          '65856','11164','10491','66023','69397',
                          '99107','15558','17894','60586','71470',
                          '14345','95710','73818','60000','90813',
                          '41978','76207','10434','89725','12323',
                          '17914','98372','59059','43807','94758',
                          '50213','17082','84063','53813','57138',
                          '25463','61087','47147','21327','90544',
                          '89693','72916','32433','36228','40250',
                          '97608','51437','22857','18908','54943',
                          '41721','43644','78649','83048','46154',
                          '90789','11343','42411','67477','78891',
                          '35802','47939','41205','26211','22938',
                          '58978','22352','41796','19098','43871',
                          '42887','35351','78742','82659','31122',
                          '27566','45927','66638','32165','36829',
                          '31112','16425','15547','74050','19260',
                          '39915','73376','25822','18520'))
     intersect
     (select ca_zip
