...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-12' as date) 
                  and (cast('2001-08-12' as date) +  30 days)
       and ss_store_sk = s_store_sk
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-05-18' as date) - 30 days)
                    and (cast ('2000-05-18' as date) + 30 days)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('cornflower','firebrick','lace','black','snow','aquamarine') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Bethel','Lakeview','Shady Grove','Oak Hill') 
...
and cc_county in ('Huron County','Luce County','San Miguel County','Jefferson Davis Parish',
                  'Franklin Parish'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Nassau County','Beaverhead County','Haskell County','Wayne County','Whatcom County') and
...
select  i_item_id
 ...
 and d_date between cast('1998-03-22' as date) and (cast('1998-03-22' as date) +  60 days)
 and i_manufact_id in (913,800,775,749)
...
where 
	...
	and d_date between cast('2002-04-17' as date) 
				and (cast('2002-04-17' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 40 and 40+10 
             or ss_coupon_amt between 12487 and 12487+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 12 and 12+10
          or ss_coupon_amt between 7405 and 7405+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 99 and 99+10
          or ss_coupon_amt between 2532 and 2532+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 145 and 145+10
          or ss_coupon_amt between 4347 and 4347+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 46648 and 46648+28800 
 	and sm_carrier in ('TBS','FEDEX')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 3193072
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 5709457
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1637473
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3250664
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 4457436
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Children','Shoes','Women') and
          i_class in ('toddlers','kids','fragrances')
         )
      or (i_category in ('Men','Music','Sports') and
          i_class in ('sports-apparel','classical','baseball') 
        ))
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '12908','39357','76984','46270','13444','56681',
                          '11678','44386','44916','86428','56602',
                          '57711','38240','65330','47585','62513',
                          '69655','44258','59781','83296','24318',
                          '41580','84467','81285','89838','12804',
                          '51536','93735','49879','50097','30544',
                          '14928','30474','74447','54147','51112',
                          '40848','18121','42568','27343','33769',
                          '85009','26334','22362','66991','60599',
                          '31212','26259','68257','12027','42786',
                          '82259','25024','14721','36794','15331',
                          '25535','25016','40889','25316','12419',
                          '43379','42674','27027','39267','50966',
                          '48447','52862','21036','85483','51280',
                          '93354','83575','82079','36184','26944',
                          '22002','32237','44682','11708','10509',
                          '21986','40253','59817','80514','97213',
                          '72491','88019','51711','20523','10498',
                          '11943','57988','31016','21636','27715',
                          '25664','26773','77993','69921','91349',
                          '32284','51023','67122','79618','29069',
                          '58439','53571','83326','65858','49586',
                          '18656','36216','67020','16372','23312',
                          '31003','33419','63727','49978','25144',
                          '30650','18398','20833','74347','60855',
                          '34465','74051','11171','43601','22272',
                          '28494','54293','12061','29882','39942',
                          '36385','23795','69273','16427','97706',
                          '48766','87441','94854','27789','54787',
                          '80241','11942','76700','82147','11207',
                          '56565','95659','92094','96040','36068',
                          '33401','11660','48422','18906','72962',
                          '88056','54279','18797','73517','79544',
                          '39527','19234','19538','84544','79362',
                          '37286','46381','58329','95993','24521',
                          '20820','62979','21838','68563','53119',
                          '29488','21067','74519','58147','34122',
                          '28109','37901','74729','34703','74706',
                          '54623','90729','81115','16676','59750',
                          '22541','67326','57552','88086','36493',
                          '28000','94113','83149','26233','33962',
                          '24555','69277','77870','22395','43454',
                          '15001','27604','19121','47574','94415',
                          '60544','78369','27785','61942','74854',
                          '66914','11747','94195','60481','20039',
                          '19536','29836','77210','24772','75908',
                          '51030','10403','22646','16285','91534',
                          '90862','10922','17957','68862','36779',
                          '32541','17287','17834','41110','47738',
                          '91876','20933','32457','55576','27531',
                          '15488','81113','72222','28402','36277',
                          '21043','74454','16128','91984','28269',
                          '68607','45936','20180','45714','34228',
                          '41548','95408','12965','66975','15417',
                          '64621','41180','52017','37902','78225',
                          '83444','34690','11666','96521','80040',
                          '95339','37523','23928','46346','58942',
                          '18284','69622','23025','54283','68067',
                          '45357','19362','74949','75399','16323',
                          '38845','96021','62505','19993','53759',
                          '97850','77862','44071','11158','92151',
                          '32961','12292','44093','51797','91518',
                          '95116','18777','48136','88156','62166',
                          '36938','35628','29253','56364','46018',
                          '10616','61395','35758','29399','82087',
                          '16853','64713','82463','64777','77726',
                          '60615','81492','72674','62674','29723',
                          '79590','65165','37610','37102','58839',
                          '96014','36009','18719','65021','99597',
                          '27978','99800','50098','19739','74240',
                          '29762','11035','22637','15218','42241',
                          '91631','34815','43501','91926','69575',
                          '90537','96326','64321','71434','37876',
                          '43062','34822','78030','27490','79061',
                          '49827','14998','14925','61149','85762',
                          '15501','23688','62679','42616','52590',
                          '78520','84446','88070','13081','43456',
                          '14458','23240','56220','72287','82585',
                          '50515','11336','18854','30689','86276',
                          '34390','79052','53756','61532'))
     intersect
     (select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2001-05-24' as date) 
				and (cast('2001-05-24' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('2001-03-15' as date) 
 				and (cast('2001-03-15' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-29' as date) and (cast('2000-03-29' as date) +  60 days)
 and i_manufact_id in (409,293,56,672)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Barrow County','Daviess County','Walker County','San Miguel County',
                           'Fairfield County','Luce County','Richland County','Kittitas County')
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-21' as date) 
                  and (cast('2002-08-21' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Plainview'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  29232
   and ib_upper_bound   <=  29232 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('tomato','moccasin','ghost'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 3
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-03-11' as date) - 30 days)
                and (cast ('1998-03-11' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,4,11,12,10,5) and
       d_year = 2000 and
       ca_state in ('WV','TN','TX'
                   ,'IL','OK','VA','SD')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'GA', 'MO')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NH', 'FL', 'IA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'TX', 'WV')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-21','2000-08-21','2000-11-14')))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-18' as date) 
                  and (cast('1998-08-18' as date) +  14 days)
