...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('smoke','steel','lawn'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-03-12','2001-08-04','2001-11-04')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 100 and 100+10 
             or ss_coupon_amt between 5952 and 5952+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 153 and 153+10
          or ss_coupon_amt between 5094 and 5094+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 11658 and 11658+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 46 and 46+10
          or ss_coupon_amt between 3521 and 3521+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Oakland','Cedar Grove')
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '29808','14606','78510','49653','57077','32309',
                          '24965','39184','28966','61295','52392',
                          '17673','37625','83241','41350','23710',
                          '18593','47133','42069','83580','66640',
                          '28552','76704','22659','12336','24605',
                          '58577','26329','38438','82815','68460',
                          '73049','25603','49913','92617','29922',
                          '19149','24487','29230','41569','28290',
                          '92078','40543','89578','35321','26758',
                          '99015','62260','73745','85330','86784',
                          '18393','14527','95146','94902','47351',
                          '12542','46234','72205','67465','95051',
                          '41778','68546','92016','77196','96647',
                          '62729','37935','98220','26749','41443',
                          '35315','61709','40745','78589','65500',
                          '61614','73082','85910','43698','49095',
                          '91870','89695','75705','33809','49569',
                          '48482','52686','93053','99376','51362',
                          '28592','35153','65348','95793','87058',
                          '35953','24241','13582','47547','67138',
                          '48757','36914','51670','91769','82512',
                          '23730','99393','28954','45472','91166',
                          '37534','11517','45523','52688','83986',
                          '81369','33479','62761','96078','77044',
                          '37902','40522','55447','91474','69101',
                          '80366','68755','37886','14802','91318',
                          '15680','47216','99293','74038','96201',
                          '99134','47766','97069','77330','69840',
                          '24658','50311','88984','86917','11119',
                          '41793','12156','92114','56336','99327',
                          '14147','89884','58628','21893','83332',
                          '54492','55614','69042','50186','31394',
                          '45691','60673','31983','80355','21811',
                          '48540','61346','47896','89452','27647',
                          '44920','10854','73389','44707','17551',
                          '32222','29404','58334','13246','11358',
                          '66247','75530','23769','12766','23201',
                          '51274','62378','31827','56978','84254',
                          '55800','17960','19204','51251','10430',
                          '86133','40412','74757','92072','94842',
                          '30237','81832','90518','40830','57937',
                          '67770','48395','79577','65934','82944',
                          '17748','96399','85067','71340','86320',
                          '64236','24792','16560','95432','28593',
                          '94845','81925','41139','44808','27082',
                          '97629','27758','62146','10237','37934',
                          '86472','88779','28980','11730','81956',
                          '89787','47093','12775','48481','96510',
                          '29511','63781','31384','61119','30836',
                          '39479','53402','49641','84130','94537',
                          '71445','88092','81510','28934','93178',
                          '94672','60064','50463','37166','64046',
                          '91060','73098','86949','19771','42815',
                          '25539','72486','22869','50565','84448',
                          '14459','65527','63449','67268','42832',
                          '99105','11736','23492','75963','63406',
                          '28857','42986','26316','27958','70627',
                          '67589','20076','77053','71555','38770',
                          '50064','50899','48951','79346','80561',
                          '25625','80487','89409','86654','60622',
                          '85622','91636','91912','73152','15350',
                          '28932','47791','68728','92217','52655',
                          '63058','84485','57531','11655','56606',
                          '52416','87003','97543','41048','29431',
                          '45583','75755','93179','87485','75559',
                          '84304','41604','37669','38038','41615',
                          '90416','29405','66238','63182','59289',
                          '21654','33108','41137','54342','57514',
                          '53950','52407','41362','81931','54875',
                          '27330','92348','18438','82804','16219',
                          '95601','61988','34783','87172','21574',
                          '38959','30973','61925','53530','94389',
                          '53555','12003','60613','23568','63826',
                          '85318','95392','87446','21966','13163',
                          '12408','26166','76700','22927','20485',
                          '65092','49823','10532','29418','40972',
                          '12400','77516','10553','56942','82737',
                          '31071','15010','39469','98088','85164',
                          '37550','97419','31690','42035','41338',
                          '68322','64879','83215','84831'))
     intersect
     (select ca_zip
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-20' as date) 
                  and (cast('2002-08-20' as date) +  30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1998-03-22' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1998-03-22' as date) - 30 days)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Oswego County','Hyde County','Mahnomen County','Fall River County','Muhlenberg County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('1998-05-18' as date) and (cast('1998-05-18' as date) +  60 days)
 and i_manufact_id in (46,263,728,430)
...
and cc_county in ('Williamson County','Franklin Parish','Fairfield County','Huron County',
                  'Daviess County'
)
and exists (select *
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2002-06-09' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-06-09' as date) - 30 days)
                and (cast ('2002-06-09' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('San Miguel County','Dauphin County','Daviess County','Franklin Parish')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'New Hope'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  42634
   and ib_upper_bound   <=  42634 + 50000
...
select  i_item_id
 ...
 and i_manufact_id in (800,901,743,964)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('1998-03-31' as date) 
				and (cast('1998-03-31' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('hot','metallic','green','floral','moccasin','saddle') and
...
select  i_item_desc 
 ...
 and d_date between cast('2000-06-23' as date) 
 				and (cast('2000-06-23' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 5537226
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 6237211
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1817809
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 11111262
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 10740186
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
and d_date between '2000-03-10' and 
        (cast('2000-03-10' as date) + 90 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,12,2,9,4,10) and
       d_year = 2001 and
       ca_state in ('PA','NC','NY'
                   ,'WI','CA','IN','MN')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Dauphin County','San Miguel County','Bronx County','Kittitas County',
                           'Fairfield County','Walker County','Ziebach County','Jefferson Davis Parish')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MD', 'OR', 'NY')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'PA', 'KS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'UT', 'AR')
...
and d_date between '2001-01-12' and 
        (cast('2001-01-12' as date) + 90 days)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Sunnyside','Oakland','Bethel','Lakeview','Salem') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Music','Sports','Home') and
          i_class in ('rock','outdoor','kids')
         )
      or (i_category in ('Shoes','Jewelry','Electronics') and
          i_class in ('womens','pendants','disk drives') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 48360 and 48360+28800 
