...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Music','Jewelry','Children') and
          i_class in ('rock','pendants','school-uniforms')
         )
      or (i_category in ('Shoes','Books','Sports') and
          i_class in ('mens','sports','sailing') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,3,7,8,4,9) and
       d_year = 1999 and
       ca_state in ('SD','KY','PA'
                   ,'IN','IL','NY','IA')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cream','thistle','powder'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 2
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MT', 'NM', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SD', 'VA', 'MS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'TN', 'IN')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Franklin'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  60859
   and ib_upper_bound   <=  60859 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('DeKalb County','Hockley County','Morton County','Des Moines County','Ellis County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '57698','16246','92843','52585','61396','77209',
                          '55038','78369','67748','50333','20992',
                          '29925','29103','88078','89513','88648',
                          '38763','22863','84839','83346','21306',
                          '54858','94226','69183','99163','11070',
                          '80569','41315','59985','93597','94394',
                          '29760','24448','20083','53684','98324',
                          '90780','39151','81741','77356','19516',
                          '16737','47046','70015','88493','77195',
                          '59214','10315','86925','47460','86379',
                          '29643','72286','29652','89745','87465',
                          '28414','22096','76258','56017','12659',
                          '56039','39799','39564','95226','26557',
                          '66506','98146','12821','18538','67723',
                          '65347','45612','76562','82691','29806',
                          '43153','69170','85817','84712','31353',
                          '41048','11011','81518','42517','38461',
                          '85020','21977','18981','22669','48258',
                          '12625','83212','93769','99494','46898',
                          '79036','39049','87811','30460','42035',
                          '20945','47174','40061','14284','25566',
                          '45054','39262','69060','82619','69146',
                          '98428','47818','40320','37130','11964',
                          '23688','26959','30112','37648','42927',
                          '18605','34930','40021','31679','12243',
                          '92445','20967','61134','46655','29054',
                          '30481','15926','78153','40261','70514',
                          '60439','76295','39108','91800','74694',
                          '61919','43230','92590','43402','90719',
                          '43085','42315','25744','10131','54729',
                          '99288','13029','31097','16810','49607',
                          '15901','65644','56006','97246','75150',
                          '73068','70238','70093','52790','91838',
                          '56920','89865','75215','92828','35586',
                          '39844','40430','52253','88824','10759',
                          '36028','61609','11259','73434','99509',
                          '44973','73224','88513','65653','31664',
                          '36661','82568','19050','36815','37787',
                          '65700','43191','12493','43780','59252',
                          '78692','94890','19334','93047','44964',
                          '76138','63988','80251','60595','60675',
                          '88110','97758','49786','66124','31140',
                          '19227','59880','29924','33323','98284',
                          '57845','75181','83806','95313','29499',
                          '43369','89447','19240','44842','40584',
                          '37364','57250','41804','97792','83296',
                          '16909','28545','92848','82285','81921',
                          '39999','34748','20890','29901','67947',
                          '20833','99359','77354','45889','19562',
                          '54325','76174','13372','96484','92731',
                          '27620','47190','91473','68609','64906',
                          '66463','67028','88137','16422','16433',
                          '77489','90970','25942','23324','82512',
                          '26481','97906','92087','73727','12224',
                          '85017','49732','64466','93483','64300',
                          '75557','79202','40619','96288','67845',
                          '68818','25229','16716','10477','35683',
                          '25192','92263','37684','85860','78581',
                          '33633','38216','12221','92914','31653',
                          '86630','34262','17100','18599','64778',
                          '67589','87016','41828','99287','20053',
                          '31552','54047','33112','58985','50735',
                          '14370','89985','12451','48950','15960',
                          '24746','82405','80042','91595','57798',
                          '11823','55531','13516','51965','39904',
                          '46792','14713','54213','92031','40922',
                          '82595','78084','65802','21872','28399',
                          '71848','57526','72563','94618','89592',
                          '31053','98529','94449','62535','38724',
                          '54202','76086','49260','92265','95253',
                          '17715','87431','44599','48002','39134',
                          '15863','52712','88381','95555','48411',
                          '61828','63049','86759','68821','17193',
                          '95643','84815','49020','54438','98422',
                          '99055','28374','89275','83724','27288',
                          '44426','85165','80399','66798','96668',
                          '22874','71783','61032','35706','13388',
                          '71471','59328','85586','71503','66734',
                          '40427','86265','31358','52003','44775',
                          '73741','64838','31569','31493'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (751,919,828,727)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 18481 and 18481+28800 
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-25' as date) and (cast('2002-04-25' as date) +  60 days)
 and i_manufact_id in (529,223,256,998)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Friendship','Oakland','Lakeview','Riverside','Pleasant Hill') 
 ...
 where i_manufact_id between 924 and 924+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'firebrick' or i_color = 'chartreuse') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-05-21' as date) - 30 days)
                and (cast ('2001-05-21' as date) + 30 days) 
 group by
    w_state,i_item_id
...
and cc_county in ('Huron County','Walker County','Franklin Parish','Barrow County',
                  'Richland County'
)
and exists (select *
...
i_manufact_id = 196
and i_item_sk = ws_item_sk 
and d_date between '2001-01-03' and 
        (cast('2001-01-03' as date) + 90 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('San Miguel County','Dauphin County','Huron County','Kittitas County',
                           'Bronx County','Ziebach County','Williamson County','Barrow County')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-07-15','2001-08-11','2001-11-10')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 153 and 153+10 
             or ss_coupon_amt between 4148 and 4148+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 10785 and 10785+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 9683 and 9683+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 117 and 117+10
          or ss_coupon_amt between 7699 and 7699+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 181 and 181+10
          or ss_coupon_amt between 6124 and 6124+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 22 and 22+10
          or ss_coupon_amt between 16054 and 16054+1000
...
where 
	...
	and d_date between cast('2000-02-04' as date) 
				and (cast('2000-02-04' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('drab','blush','coral','cornflower','forest','wheat') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 371492
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2933506
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 6909332
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 10620024
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 12366012
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
and d_date between '2000-01-14' and 
        (cast('2000-01-14' as date) + 90 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Daviess County','Williamson County','Bronx County','Barrow County')
...
where 
	...
	and d_date between cast('2002-02-07' as date) 
				and (cast('2002-02-07' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1999-04-01' as date) 
 				and (cast('1999-04-01' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
