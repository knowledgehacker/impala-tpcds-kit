...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wilson'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  45150
   and ib_upper_bound   <=  45150 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('SD', 'UT', 'KY')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NY', 'VA', 'OH')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'LA', 'TX')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Kittitas County','Fairfield County','Richland County','San Miguel County',
                           'Jefferson Davis Parish','Barrow County','Dauphin County','Bronx County')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('1999-03-04' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1999-03-04' as date) - 30 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 6485009
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2023777
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 4377122
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 12188178
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 9124373
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 83 and 83+10 
             or ss_coupon_amt between 11638 and 11638+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 37 and 37+10
          or ss_coupon_amt between 14015 and 14015+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 9452 and 9452+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 22 and 22+10
          or ss_coupon_amt between 15569 and 15569+1000
...
select  i_item_id
 ...
 and i_manufact_id in (719,762,733,318)
...
and cc_county in ('Franklin Parish','San Miguel County','Luce County','Dauphin County',
                  'Huron County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Orange County','Avery County','Ontonagon County','Peoria County','Kenosha County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,11,10,5,9,6) and
       d_year = 1998 and
       ca_state in ('TN','TX','IN'
                   ,'MI','CO','MN','GA')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('New Hope','Pleasant Grove')
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 20538 and 20538+28800 
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Jefferson Davis Parish','Barrow County','Richland County','Walker County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Children','Books','Jewelry') and
          i_class in ('school-uniforms','science','gold')
         )
      or (i_category in ('Men','Shoes','Electronics') and
          i_class in ('pants','mens','personal') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 937 and 937+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'honeydew' or i_color = 'burlywood') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-07-07','1999-08-05','1999-11-14')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Pleasant Hill','Friendship','Pleasant Grove','Mount Pleasant','Glendale') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('smoke','firebrick','chocolate','honeydew','ghost','navajo') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('misty','dodger','chocolate'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 6
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-07-13' as date) and (cast('2002-07-13' as date) +  60 days)
 and i_manufact_id in (703,701,729,675)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '27100','99937','39245','33088','65070','79802',
                          '83465','49842','61600','13480','39050',
                          '50312','60784','76708','51386','43762',
                          '32405','84401','70998','34834','83401',
                          '24532','53771','17015','32310','84158',
                          '41718','75567','15697','52025','18795',
                          '83263','49073','10196','64632','10510',
                          '37189','60729','59729','60597','82690',
                          '17660','16740','54159','86944','68860',
                          '79403','48650','39130','71687','42529',
                          '52810','87773','69768','47051','67860',
                          '33093','16931','14348','45424','97866',
                          '54197','53920','24599','51954','20855',
                          '38663','10849','56743','79545','97748',
                          '26131','75500','17364','22281','93918',
                          '31920','79173','49141','11102','60448',
                          '60180','86469','34982','85544','24676',
                          '43976','90321','54571','72438','64380',
                          '62903','90949','29743','69853','29078',
                          '95527','98120','73778','92362','58088',
                          '29058','79435','22169','58048','41098',
                          '92982','94847','15809','32929','78762',
                          '71000','65255','98127','62344','23204',
                          '66847','48608','75452','11570','56516',
                          '43339','61793','29834','16054','35165',
                          '62902','62335','98044','67776','55238',
                          '10028','18678','32283','29513','90713',
                          '64660','96398','93065','60890','64882',
                          '12786','71161','91751','38836','75449',
                          '18247','17876','29669','76237','98653',
                          '61808','24075','35502','59828','56427',
                          '98050','31324','34369','94546','95699',
                          '60872','64364','54043','73459','24031',
                          '38572','66292','64414','93538','59485',
                          '37686','49825','98407','11968','21088',
                          '80963','18297','36034','18038','91770',
                          '14695','12086','52136','43198','94071',
                          '84220','97180','71812','50914','92689',
                          '52257','43685','90243','36931','53896',
                          '19440','24500','81428','71816','45193',
                          '16096','46221','37205','74989','65478',
                          '46520','81924','85513','96491','67047',
                          '79231','36533','34650','67740','52378',
                          '47890','37460','85851','76110','79503',
                          '91449','33502','38662','79242','20286',
                          '22029','84723','78453','24001','63987',
                          '75010','69183','53587','23158','42488',
                          '40082','74772','81006','51786','73334',
                          '22864','31651','11223','70303','97013',
                          '68979','83936','24411','28895','56862',
                          '77437','43776','41477','47338','49863',
                          '57062','49388','90927','32773','34800',
                          '84058','21290','25157','38954','39149',
                          '64213','51290','95631','51762','77451',
                          '45944','11510','65317','13228','73339',
                          '86281','63932','29988','45965','68446',
                          '62924','80623','91001','32468','85247',
                          '15345','21286','42130','97740','96535',
                          '43806','62501','89722','37604','91375',
                          '73838','18341','65788','89619','86361',
                          '48220','70860','21451','98070','31028',
                          '74377','44560','84857','37139','32389',
                          '71675','73849','11242','88067','93678',
                          '85877','20324','11989','95696','30271',
                          '94009','40551','79208','63668','34068',
                          '20127','22794','21739','36555','94719',
                          '66308','38645','95145','37693','26387',
                          '64895','33679','29937','36767','22630',
                          '97997','76807','97388','10966','49137',
                          '90682','64428','59409','79911','30442',
                          '77915','32906','38543','12942','24674',
                          '28414','91747','36747','20419','71185',
                          '61313','22283','30145','41042','27321',
                          '86613','16641','51231','67348','67381',
                          '83155','32667','51970','76422','75946',
                          '84629','22659','83665','84702','73957',
                          '65631','66693','88246','93361','68510',
                          '85441','13407','96306','12760','11405',
                          '96756','28559','13538','69314','42815',
                          '12381','35011','42146','46129'))
     intersect
     (select ca_zip
