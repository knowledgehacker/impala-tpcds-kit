...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Riverside','Midway','Oak Grove','Five Points','Pleasant Hill') 
...
select  
 ...
 where
  ...
  ca_county in ('Eau Claire County','Avery County','Carter County','Archer County','Butler County') and
...
select  i_item_id
 ...
 and d_date between cast('1998-06-20' as date) and (cast('1998-06-20' as date) +  60 days)
 and i_manufact_id in (920,723,840,958)
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 122 and 122+10
          or ss_coupon_amt between 2690 and 2690+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 8907 and 8907+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 32 and 32+10
          or ss_coupon_amt between 6945 and 6945+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 71 and 71+10
          or ss_coupon_amt between 6640 and 6640+1000
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'GERMA' || ',' || 'LATVIAN' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 16157 and 16157+28800 
 	and sm_carrier in ('GERMA','LATVIAN')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 117492
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2108423
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1637538
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 525616
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 489925
            then (select avg(ss_ext_tax)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Men','Music','Electronics') and
          i_class in ('shirts','pop','stereo')
         )
      or (i_category in ('Books','Home','Sports') and
          i_class in ('self-help','mattresses','archery') 
        ))
 ...
 where i_manufact_id between 757 and 757+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'honeydew' or i_color = 'antique') and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '47129','76540','61531','27690','74812','67809',
                          '22507','96767','92789','11884','60504',
                          '45999','24307','59980','49828','68475',
                          '84066','64656','74305','27317','13230',
                          '11370','65427','32522','32035','47251',
                          '27666','56358','12885','62372','92482',
                          '12862','87035','31748','29281','56663',
                          '83426','51659','36155','37154','73011',
                          '22516','83612','15890','35507','59479',
                          '77269','64571','22575','50345','52287',
                          '16463','28923','76366','42366','50513',
                          '13935','40888','84686','22046','14326',
                          '13416','87416','25161','34502','71032',
                          '21197','45567','11969','83885','48993',
                          '19499','74635','15225','97438','46753',
                          '79997','36046','21352','92875','22256',
                          '92218','48432','21490','51515','62143',
                          '40682','45833','43561','42268','20627',
                          '41337','25157','16084','25703','54177',
                          '38969','88210','24823','70567','58670',
                          '47138','93291','14613','95018','12179',
                          '15267','96861','24287','57460','87425',
                          '77084','21895','66643','17404','41297',
                          '85796','51249','75207','80294','30035',
                          '80231','93268','86221','12523','26145',
                          '79275','60004','52636','33478','80942',
                          '79696','24379','38789','29978','35929',
                          '20773','50012','10319','35118','49039',
                          '69534','44459','82189','97993','45544',
                          '24115','13525','16550','64818','86455',
                          '40668','34466','10174','67754','87087',
                          '90232','34602','73316','62177','84611',
                          '49221','42033','22469','61234','54354',
                          '66333','80741','13260','87176','82932',
                          '41889','49219','54953','13877','38674',
                          '88724','54804','70611','77253','67846',
                          '44725','52247','48937','87838','55974',
                          '49104','38744','42474','10364','97538',
                          '43744','58027','83498','50251','69962',
                          '46907','55318','21119','15702','42080',
                          '12342','12162','86658','25826','71748',
                          '23748','48500','24926','65692','26707',
                          '59851','57440','74620','62275','32887',
                          '10958','31260','76382','10792','12724',
                          '30077','54601','74068','73773','68663',
                          '18530','64481','60245','55399','22536',
                          '89105','44195','68421','46847','16963',
                          '98068','28374','49703','50899','23569',
                          '99914','59076','46506','97847','44500',
                          '64497','90553','86752','96407','49095',
                          '19608','11964','11187','29989','32226',
                          '21682','14357','80048','14008','86457',
                          '34192','75003','85768','16915','73444',
                          '58938','76497','44976','80377','36764',
                          '47634','96510','34486','12980','26401',
                          '40739','61825','80037','51075','66621',
                          '42327','55541','57843','75830','31756',
                          '62745','44794','13364','48082','17954',
                          '70848','41007','98339','29797','26932',
                          '68574','29183','38447','23176','44584',
                          '97778','96162','25056','81812','19520',
                          '63148','89764','77051','99485','78361',
                          '95470','10560','52978','42488','19484',
                          '97164','80705','44242','66074','97170',
                          '41221','90483','22892','83282','79238',
                          '76407','79983','79211','64122','84191',
                          '72939','61461','82915','64794','80949',
                          '57423','20521','16077','63724','57383',
                          '72859','71077','56692','24344','30784',
                          '25957','70219','29472','97767','15895',
                          '42716','77974','37938','58327','82259',
                          '44455','47310','25028','42308','36128',
                          '25666','76702','22458','55455','49040',
                          '59381','35147','74952','75065','31721',
                          '97218','15858','48381','38077','80457',
                          '86534','82637','96325','36071','79625',
                          '41870','36473','44916','83307','46334',
                          '31837','38147','95086','71374','70137',
                          '22600','91182','18516','22506','43906',
                          '27064','81725','70941','59056'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-04' as date) and (cast('2000-03-04' as date) +  60 days)
 and i_manufact_id in (810,513,54,694)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bunker Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  48700
   and ib_upper_bound   <=  48700 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('dodger','plum','cornsilk'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 2
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,10,12,9,6,1) and
       d_year = 1999 and
       ca_state in ('MI','ID','RI'
                   ,'TX','IN','OH','KY')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'IA', 'SC')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'CO', 'LA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IN', 'OK', 'AL')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-03-22','2002-08-31','2002-11-13')))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-28' as date) 
                  and (cast('1999-08-28' as date) +  14 days)
