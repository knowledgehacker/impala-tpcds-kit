...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('lace','antique','dark'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-01-18','1999-08-19','1999-11-18')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 40 and 40+10 
             or ss_coupon_amt between 14791 and 14791+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 11181 and 11181+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 1861 and 1861+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '32132','46233','40315','98988','13076','92244',
                          '69621','49527','70104','72642','55510',
                          '38725','66734','28551','74878','88937',
                          '31691','41278','85754','31002','27717',
                          '52587','57680','89549','80875','41531',
                          '63399','85937','63859','92186','83757',
                          '91011','25157','17180','26596','85906',
                          '98998','46355','24877','66135','41624',
                          '95279','18779','11800','45208','25961',
                          '71241','19686','53077','59702','74899',
                          '99600','77612','85525','37403','24406',
                          '50863','46658','34328','80942','57418',
                          '65756','85114','77858','58455','48285',
                          '59179','36962','14023','57877','38787',
                          '67974','14749','44637','68613','18885',
                          '67735','75141','29847','77231','39165',
                          '94073','18567','40266','69616','33311',
                          '19881','18044','52458','24696','86920',
                          '76672','41107','54827','30414','69589',
                          '65446','98326','91665','82325','29543',
                          '67401','54483','83009','23006','51820',
                          '52354','61536','12897','85492','78082',
                          '63608','29041','91741','75684','68372',
                          '68645','33479','15814','77843','82458',
                          '58375','65702','95252','40463','79714',
                          '38820','22169','55081','99833','35053',
                          '95638','31903','48518','91009','73605',
                          '12585','44949','95212','69844','66208',
                          '80597','82822','90041','20757','85392',
                          '58721','15837','70241','55951','99262',
                          '24353','24917','79944','50439','54938',
                          '30057','17703','42877','25393','64056',
                          '54780','92809','37323','83590','77741',
                          '82933','25587','33593','89416','32354',
                          '80002','22552','25971','88382','70834',
                          '70734','57436','95051','46905','70532',
                          '26625','59297','88167','51095','48950',
                          '27961','58540','65601','38332','97342',
                          '29984','47584','69469','76874','24911',
                          '36816','70700','53098','50527','22220',
                          '28248','28746','93351','14743','95035',
                          '66076','91176','89301','65569','18542',
                          '18763','15709','75106','19711','48515',
                          '25365','99531','49013','53660','97399',
                          '29294','64289','88207','91799','31247',
                          '43443','40366','90678','60176','84085',
                          '81962','17604','23751','20582','70110',
                          '92614','16767','20472','12879','74806',
                          '31959','37818','30846','95224','86406',
                          '34127','72051','20536','99395','23112',
                          '45264','25695','45412','79312','50836',
                          '50687','26626','13164','18874','66620',
                          '95728','48469','84896','53875','92075',
                          '26976','81618','55901','31308','65192',
                          '34462','19753','74754','28332','45113',
                          '71743','74274','26846','97105','71391',
                          '47263','21078','39498','73098','68459',
                          '74809','54510','47600','74404','78842',
                          '21730','88268','95661','28307','98581',
                          '88079','86756','48631','91156','75513',
                          '86093','33912','58536','87365','62619',
                          '48001','23786','62067','89761','29995',
                          '34021','15838','36902','28524','66774',
                          '71895','78154','87117','11816','80711',
                          '14155','72092','28989','60901','80989',
                          '35129','68069','69085','19452','33975',
                          '13723','94927','57843','69579','11750',
                          '87720','78545','64029','88220','78101',
                          '65027','19592','78445','24945','16906',
                          '21916','16312','71704','36988','69872',
                          '61131','66314','58834','88166','33169',
                          '82714','16945','41022','12963','96469',
                          '32536','69636','98960','78075','81030',
                          '15794','88913','65611','83203','73600',
                          '10165','87683','15565','14604','13555',
                          '30112','50477','25641','94745','42190',
                          '91048','32342','20695','75896','51307',
                          '12984','81702','90721','85259','43176',
                          '72742','65238','65000','98591','22041',
                          '19436','39894','72089','48297'))
     intersect
     (select ca_zip
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-13' as date) 
                  and (cast('1998-08-13' as date) +  30 days) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Jackson County','Hudson County','Kershaw County','Henderson County','DuPage County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and i_manufact_id in (203,661,353,103)
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2001-02-06' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-02-06' as date) - 30 days)
                and (cast ('2001-02-06' as date) + 30 days) 
 group by
    w_state,i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Brownsville'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  48071
   and ib_upper_bound   <=  48071 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-20' as date) and (cast('1999-07-20' as date) +  60 days)
 and i_manufact_id in (778,982,824,984)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navajo','smoke','drab','forest','linen','deep') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1763640
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 921055
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 151570
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 2355156
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1806339
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,9,12,11,5,6) and
       d_year = 1998 and
       ca_state in ('TX','SD','KY'
                   ,'VA','MI','NJ','IN')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NV', 'IN', 'IA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MI', 'FL', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('LA', 'SD', 'CA')
...
and d_date between '1999-01-13' and 
        (cast('1999-01-13' as date) + 90 days)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Midway','Fairview','Pleasant Hill','Oak Grove','Mount Pleasant') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Electronics','Books') and
          i_class in ('football','automotive','self-help')
         )
      or (i_category in ('Music','Men','Home') and
          i_class in ('classical','shirts','decor') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 40832 and 40832+28800 
