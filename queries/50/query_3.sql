...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Children','Home') and
          i_class in ('tennis','school-uniforms','blinds/shades')
         )
      or (i_category in ('Music','Books','Electronics') and
          i_class in ('country','computers','portable') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,2,1,4,11,8) and
       d_year = 2000 and
       ca_state in ('KY','NM','MI'
                   ,'GA','OR','TX','NC')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('deep','pink','dodger'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 7
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'MO', 'MN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WA', 'CO', 'SC')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'FL', 'UT')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bunker Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  33221
   and ib_upper_bound   <=  33221 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Latah County','Monroe County','Clatsop County','Cottle County','Shenandoah County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '34410','49879','54974','76619','94519','85391',
                          '90483','14982','60523','64966','95567',
                          '19072','76603','31825','29100','54885',
                          '10646','35851','30434','85917','80808',
                          '16506','26990','24263','65594','86779',
                          '87858','63595','18408','24117','98653',
                          '38206','62000','80181','27246','50603',
                          '61491','58161','54778','71053','85389',
                          '49894','67012','50439','77514','72517',
                          '40373','14305','53856','73501','12577',
                          '76606','71068','95282','61490','62102',
                          '38555','26524','44073','89759','25623',
                          '98182','31209','12796','36488','51984',
                          '97526','60388','75821','85219','75039',
                          '45121','96234','81373','36789','16307',
                          '87957','55028','67011','85725','41679',
                          '20699','91657','22379','93861','49417',
                          '26942','57937','60111','18231','78082',
                          '42599','54415','41752','30958','41332',
                          '52542','61744','52986','84951','41807',
                          '11552','86834','45949','51902','14129',
                          '32303','38542','36347','49149','51217',
                          '69414','39287','30832','77126','30777',
                          '71301','10626','49891','13915','16297',
                          '32142','57948','45885','33036','67623',
                          '63075','53715','53208','25434','42256',
                          '83400','95371','45716','12653','33671',
                          '58515','76181','76073','77044','73156',
                          '44217','34415','13156','78040','11118',
                          '64397','56221','22248','18947','17859',
                          '20718','40978','21572','57314','32221',
                          '13883','48067','25590','20659','39952',
                          '34619','89104','34614','72908','17787',
                          '40480','68721','59981','98270','70471',
                          '44300','97107','51459','71761','35318',
                          '71710','76922','68261','25783','23685',
                          '78438','43689','37281','77469','46043',
                          '99480','18475','18005','53600','72541',
                          '49846','69794','42630','87751','77816',
                          '84206','18067','72384','75631','10818',
                          '78312','30456','73648','45245','50979',
                          '80655','51598','55837','71723','88421',
                          '53285','45456','80012','38046','69574',
                          '64678','23936','27422','27619','26112',
                          '78986','13383','71046','53936','95608',
                          '15693','29892','77003','80911','88325',
                          '96638','41218','30748','22531','87410',
                          '93877','23713','17691','16839','96946',
                          '10426','14784','81471','62258','41243',
                          '75663','10684','79017','75953','62040',
                          '35209','99401','78985','34395','73111',
                          '28240','41761','30774','47886','37598',
                          '56101','23692','61605','66069','73699',
                          '92566','37341','47824','11535','50963',
                          '64023','27097','18888','97659','28116',
                          '98090','92204','78294','73114','80062',
                          '53099','68286','29434','93512','42613',
                          '37585','22200','41572','75389','87594',
                          '58302','98358','65812','85441','64723',
                          '77055','39082','93990','77234','72813',
                          '84331','78179','85940','97331','66217',
                          '33768','96733','72534','79468','94841',
                          '61593','77281','55400','69264','69583',
                          '90435','11938','28404','86132','13141',
                          '83184','59947','51564','90330','38511',
                          '15307','11410','37688','49979','23754',
                          '81961','79070','71326','56476','67653',
                          '27349','89657','76618','67105','10947',
                          '75125','99324','31401','72232','74008',
                          '73533','95403','90172','28016','65053',
                          '32536','58678','53496','92190','23996',
                          '37264','58018','67440','27941','57374',
                          '91833','62555','87932','36156','30407',
                          '77250','98261','88193','79259','93404',
                          '69584','84309','77570','37554','68656',
                          '22275','34742','15866','90749','50316',
                          '91724','23514','56098','53180','58271',
                          '20248','40959','51731','50747','40354',
                          '56005','47331','92131','67332','93040',
                          '22921','42751','12440','71159'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (700,925,842,760)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 25644 and 25644+28800 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2001-02-09' as date) - 30 days)
                    and (cast ('2001-02-09' as date) + 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-06-30' as date) and (cast('2001-06-30' as date) +  60 days)
 and i_manufact_id in (728,393,809,671)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Mount Pleasant','Riverside','Five Points','Oak Grove','Midway') 
 ...
 where i_manufact_id between 746 and 746+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'snow' or i_color = 'blue') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-08' as date) - 30 days)
                and (cast ('2000-03-08' as date) + 30 days) 
 group by
    w_state,i_item_id
...
i_manufact_id = 470
and i_item_sk = ws_item_sk 
and d_date between '2002-01-08' and 
        (cast('2002-01-08' as date) + 90 days)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-07-05','2001-09-28','2001-11-14')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 90 and 90+10 
             or ss_coupon_amt between 14274 and 14274+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 151 and 151+10
          or ss_coupon_amt between 12829 and 12829+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 0 and 0+10
          or ss_coupon_amt between 13094 and 13094+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 3 and 3+10
          or ss_coupon_amt between 2842 and 2842+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 921 and 921+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 116 and 116+10
          or ss_coupon_amt between 16222 and 16222+1000
...
where 
	...
	and d_date between cast('1998-06-01' as date) 
				and (cast('1998-06-01' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('azure','honeydew','violet','magenta','navy','powder') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1028743
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 2366100
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1375226
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 1012916
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 988654
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
i_manufact_id = 508
and i_item_sk = cs_item_sk 
and d_date between '1998-02-18' and 
        (cast('1998-02-18' as date) + 90 days)
