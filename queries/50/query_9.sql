...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Lakeview'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  62179
   and ib_upper_bound   <=  62179 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NM', 'SC', 'AR')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'VA', 'MT')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WY', 'NE', 'WV')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-03-27' as date) - 30 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 598120
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 458177
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 561070
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 903200
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1872037
            then (select avg(ss_ext_tax)
                  from store_sales
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2001-04-22' as date) 
				and (cast('2001-04-22' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2002-01-09' and 
        (cast('2002-01-09' as date) + 90 days)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 179 and 179+10 
             or ss_coupon_amt between 2123 and 2123+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 14397 and 14397+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 116 and 116+10
          or ss_coupon_amt between 1468 and 1468+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 9209 and 9209+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 3240 and 3240+1000
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   and i_category in ('Children', 'Women', 'Jewelry')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1998-02-20' as date) 
 				and (cast('1998-02-20' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and d_date between cast('1998-02-23' as date) and (cast('1998-02-23' as date) +  60 days)
 and i_manufact_id in (584,986,156,800)
...
select  
 ...
 where
  ...
  ca_county in ('Scott County','Mineral County','Somerset County','Mercer County','Toole County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,3,6,5,1,11) and
       d_year = 2002 and
       ca_state in ('KY','LA','TX'
                   ,'AK','MI','NC','SC')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-05-30' as date) - 30 days)
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'PRIVATECARRIER' || ',' || 'DIAMOND' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 2705 and 2705+28800 
 	and sm_carrier in ('PRIVATECARRIER','DIAMOND')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Shoes','Home','Music') and
          i_class in ('mens','paint','rock')
         )
      or (i_category in ('Jewelry','Sports','Children') and
          i_class in ('costume','basketball','infants') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 708 and 708+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'burnished' or i_color = 'blue') and
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'navy' or i_color = 'pink') and 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-03-06','1999-08-06','1999-11-11')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Midway','Pleasant Hill','Fairview','Five Points','Riverside') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','snow','sky','saddle','goldenrod','drab') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','lace','tan'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 5
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-02-13' as date) and (cast('2002-02-13' as date) +  60 days)
 and i_manufact_id in (770,728,769,731)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '25753','40302','80545','60476','84034','42312',
                          '55383','68977','50336','75950','31084',
                          '62989','33280','79472','62318','68670',
                          '81871','32910','50615','53358','77900',
                          '81208','74031','61383','80662','93922',
                          '87826','88354','14735','98524','19180',
                          '17311','73135','13608','30430','96788',
                          '38008','38750','38370','50377','32122',
                          '11556','53330','38121','94246','50389',
                          '30201','45159','36296','71260','32718',
                          '93628','95656','26734','23922','97146',
                          '91582','46623','43393','46660','80803',
                          '15670','29011','45102','40541','67877',
                          '63900','10562','75406','80749','58747',
                          '51884','34126','74014','58211','96122',
                          '87075','22594','77670','64408','70729',
                          '82790','74000','21263','98231','30407',
                          '51616','84452','50484','85321','48317',
                          '59914','87639','82950','38837','23870',
                          '17660','38982','81090','15577','59511',
                          '63409','34955','40904','53635','38509',
                          '69368','89091','86991','31040','54746',
                          '64018','61794','45821','13613','53026',
                          '52527','15219','93811','50494','91848',
                          '33177','64067','92322','76424','68810',
                          '81585','55388','92277','39007','76383',
                          '95569','56770','38482','33543','14585',
                          '11559','66777','93265','63254','46390',
                          '65871','80947','27755','17624','93070',
                          '55029','35172','31018','45802','51055',
                          '55012','16231','11178','65244','54849',
                          '95245','28444','91142','90483','26733',
                          '25694','91287','94870','23876','98820',
                          '24262','86185','80251','46931','94040',
                          '27705','66752','76373','92115','30462',
                          '70308','88059','66488','66005','31297',
                          '77234','67281','34421','92862','73075',
                          '68798','11301','46522','95760','92795',
                          '41714','84870','22802','35195','76980',
                          '88955','20643','77635','21654','49339',
                          '63891','16746','16962','79541','26173',
                          '58057','17482','60158','73886','53564',
                          '55869','33872','16963','66195','23623',
                          '86552','65966','53912','32883','16301',
                          '65075','12957','42646','50996','15045',
                          '91678','75392','47235','85068','55812',
                          '20472','79905','44989','51132','48162',
                          '27304','80973','56449','98944','20996',
                          '18256','95293','70665','52544','96770',
                          '73506','30390','86300','90889','12840',
                          '57576','94962','34262','13827','60241',
                          '75845','80908','53708','94496','65891',
                          '95140','47611','19174','66940','87101',
                          '72102','41106','51656','21997','41046',
                          '33104','18339','65964','70787','43481',
                          '84481','31673','47109','30548','88206',
                          '49655','18344','46393','12670','12352',
                          '24818','47122','24743','81158','28963',
                          '13829','36743','85121','37801','75393',
                          '85280','63174','34954','62267','47652',
                          '14872','64527','98582','79857','74930',
                          '18791','42336','32531','65479','57187',
                          '55755','99624','51377','84073','19444',
                          '44679','20326','85945','99471','68457',
                          '99954','16899','92308','83097','56163',
                          '16749','99564','46747','29690','94179',
                          '58475','31648','41778','58718','13362',
                          '42720','57124','20413','36352','40439',
                          '26745','17034','11065','84205','73536',
                          '93598','79362','62524','68849','90277',
                          '80925','52424','11221','29581','47942',
                          '17892','88535','24081','51131','12402',
                          '37831','99081','34879','85264','38393',
                          '50926','53883','80209','62089','40440',
                          '18631','70340','69911','94799','36760',
                          '45634','35105','95268','30660','16480',
                          '52637','34400','59633','78746','34203',
                          '33793','10876','88738','66202','23183',
                          '35584','81276','60175','58664','87603',
                          '14708','68603','38888','26093'))
     intersect
     (select ca_zip
